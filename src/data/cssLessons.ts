  ...
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css19-q1",
          "question": "Какая распространенная синтаксическая ошибка делает функцию calc() недействительной?",
          "options": [
            "Использование дробных чисел",
            "Отсутствие пробелов вокруг математических операторов сложения (+) или вычитания (-), например calc(100%-20px)",
            "Использование процентов",
            "Использование пикселей"
          ],
          "correctIndex": 1,
          "explanation": "Спецификация CSS строго требует пробелов вокруг + и -, чтобы отличать их от отрицательных числовых значений (-20px)."
        },
        {
          "id": "css19-q2",
          "question": "Как работает выражение width: min(100% - 32px, 1200px)?",
          "options": [
            "Ширина всегда равна 1200px",
            "Ширина выбирает наименьшее из двух значений: на узких мобильных экранах равна 100% минус 32px, а на экранах шире 1200px фиксируется на 1200px",
            "Ширина всегда равна 100%",
            "Это синтаксическая ошибка"
          ],
          "correctIndex": 1,
          "explanation": "min() выбирает наименьшее значение, выступая компактной заменой связки width: 100% и max-width: 1200px."
        },
        {
          "id": "css19-q3",
          "question": "Что означают 3 аргумента в функции clamp(MIN, PREFERRED, MAX)?",
          "options": [
            "Красный, зеленый, синий цвет",
            "Минимально допустимое значение, желаемое динамическое значение, максимально допустимое значение",
            "Начало, середина, конец анимации",
            "Ширина, высота, глубина"
          ],
          "correctIndex": 1,
          "explanation": "clamp(MIN, PREFERRED, MAX) удерживает плавающее желаемое значение строго в рамках от MIN до MAX."
        },
        {
          "id": "css19-q4",
          "question": "Почему для плавной типографики (Fluid Typography) нельзя использовать только чистые единицы vw (например, font-size: 4vw)?",
          "options": [
            "vw не поддерживается в мобильных браузерах",
            "Чистый vw не имеет минимальных и максимальных ограничений (на смартфоне шрифт станет микроскопическим), и нарушает критерии доступности WCAG, так как не реагирует на зум настроек браузера",
            "vw работает только для картинок",
            "vw запрещен стандартом W3C"
          ],
          "correctIndex": 1,
          "explanation": "Для доступности шрифт всегда должен опираться на базовый rem: clamp(1rem, 0.8rem + 1.5vw, 2.5rem)."
        },
        {
          "id": "css19-q5",
          "question": "Нужно ли оборачивать математические выражения внутри clamp(), min() и max() в функцию calc()?",
          "options": [
            "Да, всегда обязательно",
            "Нет, функции clamp(), min() и max() нативно поддерживают математические операции без использования calc()",
            "Только при операциях деления",
            "Только в браузере Safari"
          ],
          "correctIndex": 1,
          "explanation": "Современные математические функции CSS автоматически парсят и вычисляют выражения без необходимости вызывать calc()."
        }
      ]
    }
  },
