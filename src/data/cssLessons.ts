...
export const cssLessons: Lesson[] = [
  {
    ...
    "theory": {
      ...
      "sections": [
        ...
        {
          "title": "Рекомендуемые видеоматериалы: CSS для начинающих",
          "content": "Для наглядного закрепления синтаксиса CSS, селекторов, каскадности, блочной модели и практической стилизации рекомендуем видеоматериалы:\n\n- **[Полный Курс CSS / Изучение в одном видео для начинающих с нуля (YouTube)](https://youtu.be/sG12DK8vQTM?si=RBgvIW6z5sHqJi1W)** — всеобъемлющий видеокурс от школы itProger: подключение стилей, базовая стилизация текста и блоков, позиционирование, адаптивность и практические примеры верстки.\n- **[CSS для Начинающих - Практический Курс (YouTube)](https://youtu.be/SpCUuyZZTp8?si=B8mztYTL_fqIBBBp)** — фундаментальный практический видеокурс от Владилена Минина: синтаксис CSS, селекторы, специфичность, каскадность, блочная модель Box Model, Flexbox, позиционирование и верстка реального интерфейса."
        }
      ],
      "seniorTips": [
    ...
    "quiz": {
      "questions": [
        {
          "id": "c1-q1",
          "question": "Какой селектор выберет только те <p>, которые являются ПРЯМЫМИ дочерними элементами <div class=\"article\">?",
          "options": [
            ".article p",
            ".article > p",
            ".article + p",
        ...
        },
        {
          ...
          "correctIndex": 2,
          "explanation": "#header .nav-link имеет вес (0, 1, 1, 0): наличие ID перебивает любое количество классов и тегов, а div#main-header содержит ID, но меньше классов."
        },
        {
          "id": "c1-q3",
          "question": "Что произойдёт с блоком width: 200px при добавлении padding: 20px и border: 2px в режиме box-sizing: border-box?",
          "options": [
            "Итоговая ширина увеличится до 244 пикселей",
            "Итоговая ширина уменьшится до 156 пикселей",
            "Итоговая ширина останется 200px, отступы уйдут внутрь",
            "Браузер выдаст синтаксическую ошибку в консоли"
          ],
          "correctIndex": 2,
        ...
        {
          "id": "c1-q4",
          "question": "Какое из перечисленных свойств НЕ наследуется дочерними элементами автоматически?",
          "options": [
            "color",
            "font-family",
            "line-height",
          ...
          "correctIndex": 3,
          "explanation": "Отступы (margin, padding) и границы не наследуются, в отличие от шрифтов, цвета текста и межстрочного интервала."
        },
        {
          "id": "c1-q5",
          "question": "Какое правило победит, если .card-title { color: red; } и .card-title { color: green; } имеют одинаковую специфичность?",
          "options": [
            "Победит первое правило по коду — цвет red",
            "Победит объявленное ниже правило — цвет green",
            "Цвета смешаются и дадут коричневый оттенок",
            "Браузер отменит оба правила и возьмёт дефолт"
          ],
          "correctIndex": 1,
          "explanation": "По правилу каскада при равном весе специфичности всегда побеждает правило, объявленное в коде ниже."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "correctIndex": 2,
          "explanation": "justify-content распределяет flex-items вдоль главной оси, align-items — вдоль поперечной, flex-direction задаёт направление главной оси."
        },
        {
          "id": "css2-q2",
          "question": "Что означает запись flex: 0 0 260px?",
          "options": [
            "Элемент не растёт, не сжимается, ширина ровно 260px",
            "Элемент растёт с коэффициентом роста 260",
            "Элемент сжимается до минимальных 260 пикселей",
            "Элемент получает внутренний отступ 260 пикселей"
          ],
          "correctIndex": 0,
          "explanation": "flex — сокращение для grow/shrink/basis: 0 0 260px означает жёстко фиксированную ширину, идеальную для сайдбаров."
        },
        {
          "id": "css2-q3",
          "question": "Какой подход к адаптивной верстке является стандартом индустрии?",
          "options": [
            "Fixed — жёсткая ширина контейнера 1200px",
            "Desktop First — @media (max-width: ...)",
            "Fluid — только vw/vh совсем без @media",
            "Mobile First — @media (min-width: ...)"
          ],
          "correctIndex": 3,
          "explanation": "Mobile First: базовые стили для мобильных без @media, расширения через min-width. Desktop First нагружает мобилки лишними правилами."
        },
        {
          "id": "css2-q4",
          "question": "Что делает CSS-функция clamp(16px, 2.5vw, 24px)?",
          "options": [
            "Устанавливает жёстко фиксированный размер 16px",
            "Масштабирует от 16px до 24px, предпочитая 2.5vw",
            "Умножает 16px на 2.5 и вычитает 24px",
            "Анимирует размер шрифта от 16px до 24px"
          ],
          "correctIndex": 1,
          "explanation": "clamp(min, preferred, max) ограничивает значение диапазоном, позволяя создавать адаптивную типографику без @media."
        },
        {
          "id": "css2-q5",
          "question": "Для чего используется медиа-фича prefers-reduced-motion: reduce?",
          "options": [
            "Ускоряет анимации на мощных устройствах",
            "Замедляет загрузку страницы и медиафайлов",
            "Отключает анимации по запросу пользователя в ОС",
            "Блокирует автовоспроизведение видеоконтента"
          ],
          "correctIndex": 2,
          "explanation": "Фича срабатывает при включённом 'Reduce motion' в настройках ОС и критична для пользователей с вестибулярными нарушениями."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css3-q1",
          "question": "Какова реальная ширина элемента при width: 300px; padding: 25px; border: 5px solid red; box-sizing: content-box?",
          "options": [
            "270px",
            "330px",
            "360px",
          ...
          "correctIndex": 2,
          "explanation": "При content-box: 300 + 25 + 25 + 5 + 5 = 360px."
        },
        {
          "id": "css3-q2",
          "question": "Какое расстояние будет между блоками, если у верхнего margin-bottom: 40px, а у нижнего margin-top: 25px?",
          "options": [
            "65px",
            "40px",
            "25px",
          ...
          "correctIndex": 1,
          "explanation": "Вертикальные отступы соседей схлопываются в один, равный максимальному: Max(40px, 25px) = 40px."
        },
        {
          "id": "css3-q3",
          "question": "Какой современный метод создаёт Block Formatting Context без обрезки теней и выпадающих меню?",
          "options": [
            "overflow: hidden",
            "clear: both",
            "float: left",
          ...
          "correctIndex": 3,
          "explanation": "display: flow-root создан специально для активации BFC без побочных эффектов обрезки контента."
        },
        {
          "id": "css3-q4",
          "question": "В чём ключевое различие между свойствами border и outline?",
          "options": [
            "border занимает место в Box Model, outline — нет",
            "border не поддерживает указание цвета рамки",
            "outline применяется только к тегам ссылок",
            "Между этими свойствами нет никакой разницы"
          ],
          "correctIndex": 0,
          "explanation": "border влияет на геометрию и вызывает Reflow, outline рисуется поверх без изменения размеров — идеален для индикаторов фокуса."
        },
        {
          "id": "css3-q5",
          "question": "Что делает логическое свойство margin-inline: auto?",
          "options": [
            "Удаляет все внешние отступы элемента",
            "Центрирует элемент по горизонтальной оси",
            "Центрирует элемент по вертикальной оси",
            "Делает элемент плавающим слева"
          ],
          "correctIndex": 1,
          "explanation": "margin-inline: auto — современный аналог margin-left/right: auto, не затрагивающий вертикальные отступы."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            ...
            "Стоит в строке текста и игнорирует width/height",
            "Полностью исчезает со страницы и из потока",
            "Создаёт гибкий flex-контейнер для потомков"
          ],
          "correctIndex": 1,
          "explanation": "Строчные элементы встраиваются в текстовую строку и не реагируют на width, height и вертикальные margin."
        },
        {
          "id": "css4-q2",
          "question": "В чём заключается ключевое отличие display: none от visibility: hidden?",
          "options": [
            "visibility: hidden удаляет элемент из DOM-дерева",
            "display: none работает только на тегах ссылок",
            "display: none убирает из потока, visibility держит место",
            "Между этими двумя свойствами нет разницы"
          ],
          "correctIndex": 2,
          "explanation": "При display: none элемент не генерирует бокс и соседи сдвигаются, при visibility: hidden место в макете сохраняется."
        },
        {
          "id": "css4-q3",
          "question": "Почему скрытие интерактивных кнопок только через opacity: 0 является грубой ошибкой?",
          "options": [
            "Элемент остаётся кликабельным и фокусируемым",
            "Свойство opacity сильно нагружает процессор",
            "Свойство opacity нельзя плавно анимировать",
            "Свойство opacity не работает в мобильных браузерах"
          ],
          "correctIndex": 0,
          "explanation": "Прозрачный элемент остаётся на экране: по нему можно случайно кликнуть, а Tab попадёт в пустое место."
        },
        {
          "id": "css4-q4",
          "question": "Для чего применяется CSS-класс .visually-hidden (sr-only)?",
          "options": [
            "Ускоряет загрузку тяжёлых изображений страницы",
            "Создаёт трёхмерные анимации поворота элемента",
            "Скрывает элемент визуально, оставляя для скринридеров",
            "Удаляет все скрипты со страницы ради безопасности"
          ],
          "correctIndex": 2,
          "explanation": "Класс сжимает элемент до 1×1px с clip, но оставляет его в Accessibility Tree для незрячих пользователей."
        },
        {
          "id": "css4-q5",
          "question": "Что происходит с элементом при применении свойства display: contents?",
          "options": [
            "Элемент превращается в модальное окно поверх страницы",
            "Контейнер не создаёт бокс, дети поднимаются на уровень выше",
            "Все шрифты внутри элемента становятся полужирными",
            "Элемент масштабируется на весь экран устройства"
          ],
          "correctIndex": 1,
          "explanation": "display: contents визуально растворяет контейнер: у него нет фона, рамок и отступов, а дети становятся элементами родителя."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            ...
            "Относительно предыдущего соседнего элемента в потоке",
            "Относительно ближайшего предка с position не static",
            "Всегда относительно прямого родителя элемента"
          ],
          "correctIndex": 2,
          "explanation": "absolute ищет ближайшего предка с position != static, иначе отсчитывает от Initial Containing Block (<html>)."
        },
        {
          "id": "css5-q2",
          "question": "Что произойдёт с местом в потоке, если элементу задать position: relative и сдвинуть его через top/left?",
          "options": [
            "Место сохраняется, элемент смещается лишь визуально",
            "Место освобождается, соседи сдвигаются вверх",
            "Элемент полностью исчезает из DOM-дерева",
            "Ширина элемента сжимается до нуля пикселей"
          ],
          "correctIndex": 0,
          "explanation": "relative сохраняет исходное пространство в потоке: соседи не двигаются, элемент лишь визуально смещается."
        },
        {
          "id": "css5-q3",
          "question": "Почему свойство z-index: 9999 не работает на обычном блоке div?",
          "options": [
            "Значение 9999 слишком велико для спецификации CSS",
            "Свойство z-index работает только на ссылках и кнопках",
            "Свойство z-index требует обязательного фона блока",
            "z-index игнорируется при position: static"
          ],
          "correctIndex": 3,
          "explanation": "По умолчанию у элементов position: static, где z-index игнорируется. Достаточно добавить position: relative."
        },
        {
          "id": "css5-q4",
          "question": "Какое свойство является современным эквивалентом top: 0; right: 0; bottom: 0; left: 0;?",
          "options": [
            "all: 0;",
            "inset: 0;",
            "box-align: 0;",
          ...
          "correctIndex": 1,
          "explanation": "inset — логическое сокращение для одновременной установки top, right, bottom и left."
        },
        {
          "id": "css5-q5",
          "question": "Почему элемент с position: sticky может перестать прилипать при прокрутке?",
          "options": [
            "Только если у родителя задан overflow: hidden или auto",
            "Только если не указана координата top или bottom",
            "Только если высота родителя равна высоте элемента",
            "Любая из этих трёх причин ломает sticky"
          ],
          "correctIndex": 3,
          "explanation": "overflow на предках отменяет скролл-контекст, отсутствие координаты не задаёт точку залипания, а равная высота родителя не оставляет места для прокрутки."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css6-q1",
          "question": "Какой формат веб-шрифтов является современным стандартом благодаря сжатию Brotli?",
          "options": [
            "WOFF2 (Web Open Font Format 2)",
            "TTF (TrueType Font)",
            "EOT (Embedded OpenType)",
            "SVG Font (векторный шрифт)"
          ],
          "correctIndex": 0,
          "explanation": "WOFF2 использует сжатие Brotli, весит на 30% меньше WOFF и поддерживается более 99% браузеров."
        },
        {
          "id": "css6-q2",
          "question": "Что делает директива font-display: swap в правиле @font-face?",
          "options": [
            "Меняет шрифт страницы каждые пять секунд",
            "Скрывает текст, пока кастомный шрифт не загрузится",
            "Сразу рисует текст системным шрифтом, потом подменяет",
            "Отключает субпиксельное сглаживание шрифтов"
          ],
          "correctIndex": 2,
          "explanation": "swap устраняет эффект невидимого текста (FOIT): пользователь мгновенно видит контент системным шрифтом."
        },
        {
          "id": "css6-q3",
          "question": "В чём главное преимущество вариативных шрифтов (Variable Fonts)?",
          "options": [
            "Они не требуют подключения через файл CSS",
            "Один файл содержит все жирности, ширины и наклоны",
            "Они работают полностью без интернет-соединения",
            "Они всегда распространяются по бесплатной лицензии"
          ],
          "correctIndex": 1,
          "explanation": "Variable Font упаковывает непрерывный спектр начертаний в один файл ~40 КБ, заменяя 8–10 обычных файлов."
        },
        {
          "id": "css6-q4",
          "question": "Почему line-height рекомендуется задавать безразмерным множителем, а не в пикселях?",
          "options": [
            "Пиксельные значения запрещены спецификацией CSS3",
            "Безразмерный множитель ускоряет работу видеокарты",
            "Между этими двумя записями нет никакой разницы",
            "Множитель пересчитывается от font-size потомка"
          ],
          "correctIndex": 3,
          "explanation": "line-height: 1.5 даёт 150% от текущего font-size элемента, тогда как жёсткие пиксели наследуются без изменений и склеивают крупный текст."
        },
        {
          "id": "css6-q5",
          "question": "Как работает запись font-size: clamp(1.5rem, 3vw + 1rem, 3rem)?",
          "options": [
            "Ограничивает размер от 1.5rem до 3rem, масштабируя 3vw",
            "Всегда возвращает среднее арифметическое аргументов",
            "Выбирает случайный размер при каждой перезагрузке",
            "Работает только на планшетах и смартфонах"
          ],
          "correctIndex": 0,
          "explanation": "clamp держит размер не меньше MIN и не больше MAX, плавно масштабируя его по вьюпорту без медиа-запросов."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css7-q1",
          "question": "В чём фундаментальное преимущество цветового пространства OKLCH перед HSL?",
          "options": [
            "OKLCH поддерживает меньше цветов ради экономии памяти",
            "OKLCH перцептивно-равномерен и покрывает гамму P3",
            "OKLCH работает только в графических редакторах",
            "OKLCH не поддерживает альфа-канал прозрачности"
          ],
          "correctIndex": 1,
          "explanation": "В HSL жёлтый при L: 50% кажется ярче синего. В OKLCH светлота выверена по восприятию глаза, плюс поддерживается Wide Gamut P3."
        },
        {
          "id": "css7-q2",
          "question": "Какая связка свойств необходима для создания градиентного текста?",
          "options": [
            "color: gradient(red, blue) на теге заголовка",
            "text-fill: linear-gradient(red, blue) с префиксами",
            "background градиент + background-clip: text + transparent",
            "filter: hue-rotate(90deg) поверх обычного цвета"
          ],
          "correctIndex": 2,
          "explanation": "Градиент задаётся в background, background-clip: text обрезает его по контуру букв, а color: transparent открывает градиент."
        },
        {
          "id": "css7-q3",
          "question": "Что делает свойство color-scheme: dark в CSS?",
          "options": [
            "Перекрашивает все изображения в чёрно-белый вид",
            "Инвертирует абсолютно все цвета на странице",
            "Удаляет тени и обводки у кнопок и полей",
            "Включает тёмный вид скроллбаров и контролов"
          ],
          "correctIndex": 3,
          "explanation": "color-scheme: dark нативно переключает оформление системных элементов: скроллбаров, селектов, чекбоксов и date-picker."
        },
        {
          "id": "css7-q4",
          "question": "Какой градиент используется для круговых диаграмм, спиннеров и вращающихся рамок?",
          "options": [
            "linear-gradient()",
            "radial-gradient()",
            "conic-gradient()",
          ...
          "correctIndex": 2,
          "explanation": "Конический градиент распределяет цвета по кругу вокруг центральной точки от 0 до 360 градусов."
        },
        {
          "id": "css7-q5",
          "question": "Какой порядок наложения при записи background: layer1, layer2, layer3;?",
          "options": [
            "Первый указанный слой рисуется самым верхним",
            "Первый указанный слой рисуется самым нижним",
            "Порядок слоёв определяется браузером случайно",
            "Все слои автоматически сливаются в один фон"
          ],
          "correctIndex": 0,
          "explanation": "В Multiple Backgrounds первый слой рендерится сверху, перекрывая последующие — как слои в графическом редакторе."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css8-q1",
          "question": "В чём принципиальная разница между box-shadow и filter: drop-shadow()?",
          "options": [
            "box-shadow работает исключительно с текстом и шрифтами",
            "box-shadow даёт тень прямоугольника, drop-shadow — контура",
            "Функция drop-shadow запрещена на мобильных устройствах",
            "Между этими двумя способами нет никакой разницы"
          ],
          "correctIndex": 1,
          "explanation": "drop-shadow вычисляет тень по альфа-каналу, повторяя силуэты SVG-иконок, прозрачных PNG и псевдоэлементов ::after."
        },
        {
          "id": "css8-q2",
          "question": "Какое поведение обеспечивает псевдокласс :focus-visible?",
          "options": [
            "Показывает индикатор только при навигации с клавиатуры",
            "Показывает элемент только при прокрутке страницы",
            "Полностью удаляет элемент со страницы после клика",
            "Делает текст внутри элемента полужирным"
          ],
          "correctIndex": 0,
          "explanation": ":focus-visible не раздражает пользователей мыши, но обеспечивает четкую рамку фокуса при табуляции."
        },
        {
          "id": "css8-q3",
          "question": "Какая комбинация свойств создаёт эффект матового стекла (Glassmorphism)?",
          "options": [
            "opacity: 0.5 вместе с filter: blur(5px) на блоке",
            "Полупрозрачный фон, backdrop-filter: blur() и border",
            "Чёрный фон и белая тень box-shadow вокруг блока",
            "display: grid вместе с overflow: hidden на блоке"
          ],
          "correctIndex": 1,
          "explanation": "Glassmorphism требует трёх компонентов: полупрозрачного фона, backdrop-filter: blur() и тонкой светящейся границы."
        },
        {
          "id": "css8-q4",
          "question": "Почему outline предпочтительнее border для отображения фокуса?",
          "options": [
            "outline вообще не поддерживается браузером Firefox",
            "outline меняет цвет фона элемента при фокусе",
            "border невозможно анимировать через transition",
            "outline не влияет на геометрию и не двигает соседей"
          ],
          "correctIndex": 3,
          "explanation": "outline рисуется поверх элемента, не меняя размеров контейнера, а outline-offset отодвигает рамку для лучшей видимости."
        },
        {
          "id": "css8-q5",
          "question": "Как создать эллиптическое скругление с разными радиусами по горизонтали и вертикали?",
          "options": [
            "border-radius: 50%;",
            "border-radius: 50px / 25px;",
            "border-ellipse: 50px 25px;",
            "border-round: 50px 25px;"
          ],
          "correctIndex": 1,
          "explanation": "Синтаксис со слешем задаёт горизонтальный радиус 50px и вертикальный 25px, создавая органические формы."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css9-q1",
          "question": "Какая комбинация свойств обеспечивает идеальное горизонтальное и вертикальное центрирование?",
          "options": [
            "text-align: center вместе с vertical-align: middle",
            "display: flex, justify-content: center, align-items: center",
            "margin: 0 auto вместе с padding: auto на блоке",
            "float: center вместе с clear: both на блоке"
          ],
          "correctIndex": 1,
          "explanation": "Эта тройка свойств — каноническое решение задачи полного центрирования в CSS."
        },
        {
          "id": "css9-q2",
          "question": "Что произойдёт с justify-content и align-items при установке flex-direction: column?",
          "options": [
            "Оба свойства перестают работать в режиме column",
            "Ничего не изменится: оси остаются на прежних местах",
            "justify-content управляет вертикалью, align — горизонталью",
            "Оба свойства начинают управлять только цветом фона"
          ],
          "correctIndex": 2,
          "explanation": "При column главная ось разворачивается вертикально, поэтому justify-content распределяет по вертикали, а align-items выравнивает по горизонтали."
        },
        {
          "id": "css9-q3",
          "question": "Какое преимущество даёт свойство gap перед margin для отступов между flex-элементами?",
          "options": [
            "Свойство gap умеет анимировать появление элементов",
            "gap создаёт отступы только между элементами, не по краям",
            "Свойство gap пока не поддерживается в Chrome",
            "Свойство gap принимает только процентные значения"
          ],
          "correctIndex": 1,
          "explanation": "gap генерирует промежутки только между соседями, тогда как margin добавляет лишние отступы по краям контейнера."
        },
        {
          "id": "css9-q4",
          "question": "Как прижать элемент к правому краю flex-контейнера без пустых Spacer-элементов?",
          "options": [
            "Установить margin-left: auto на нужном элементе",
            "Применить float: right к нужному элементу",
            "Применить text-align: right к контейнеру",
            "Применить position: absolute и right: 0"
          ],
          "correctIndex": 0,
          "explanation": "margin: auto во Flexbox поглощает всё свободное пространство, прижимая элемент к противоположному краю."
        },
        {
          "id": "css9-q5",
          "question": "Какое значение justify-content создаёт одинаковые промежутки между элементами и по краям?",
          "options": [
            "space-between",
            "space-around",
            "space-evenly",
          ...
          "correctIndex": 2,
          "explanation": "space-evenly распределяет абсолютно равные промежутки и между элементами, и от элементов до краёв контейнера."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css10-q1",
          "question": "Зачем на круглые аватарки и иконки внутри flex-контейнеров всегда ставят flex-shrink: 0?",
          "options": [
            "Чтобы изображение стало идеально круглым по форме",
            "Чтобы длинный текст рядом не сплющил картинку в овал",
            "Чтобы поменять цвет иконки при наведении курсора",
            "Чтобы ускорить загрузку файла изображения по сети"
          ],
          "correctIndex": 1,
          "explanation": "По умолчанию flex-shrink: 1, поэтому при переполнении браузер сжимает соседние элементы. Значение 0 фиксирует размеры."
        },
        {
          "id": "css10-q2",
          "question": "В чём преимущество flex: 1 перед flex-grow: 1 для создания равных колонок?",
          "options": [
            "Запись flex: 1 работает примерно в два раза быстрее",
            "Свойство flex-grow полностью устарело в CSS3",
            "Между этими двумя записями нет никакой разницы",
            "flex: 1 сбрасывает basis в 0%, давая равные колонки"
          ],
          "correctIndex": 3,
          "explanation": "flex: 1 задаёт flex-basis: 0% и делит ширину поровну, тогда как flex-grow: 1 сохраняет basis: auto и делает колонку с длинным текстом шире."
        },
        {
          "id": "css10-q3",
          "question": "Какое свойство позволяет ОДНОМУ flex-элементу переопределить align-items контейнера?",
          "options": [
            "align-content",
            "justify-self",
            "align-self",
          ...
          "correctIndex": 2,
          "explanation": "align-self задаётся на самом flex-элементе и переопределяет родительское align-items только для этого узла."
        },
        {
          "id": "css10-q4",
          "question": "Как задать сайдбар шириной 280px, который не сжимается и не растёт?",
          "options": [
            "flex: 0 0 280px (или flex: none плюс width)",
            "width: 280px без каких-либо flex-свойств",
            "flex-grow: 280 на элементе боковой панели",
            "flex: 1 280px на элементе боковой панели"
          ],
          "correctIndex": 0,
          "explanation": "flex: 0 0 280px задаёт grow: 0, shrink: 0 и basis: 280px, фиксируя размер намертво."
        },
        {
          "id": "css10-q5",
          "question": "Почему изменение визуального порядка через order может нарушить доступность?",
          "options": [
            "Свойство order физически удаляет текст элемента",
            "Свойство order не поддерживается на мобильных",
            "Свойство order сильно замедляет работу GPU",
            "order меняет картинку, но не порядок Tab и чтения"
          ],
          "correctIndex": 3,
          "explanation": "order влияет только на визуальный рендеринг, а фокус клавиатуры и скринридеры следуют порядку узлов в HTML."
        }
      ]
    }
  },
  {
    ...
    "theory": {
      ...
      "sections": [
        ...
        {
          "title": "Рекомендуемые видеоматериалы: CSS Grid Layout",
          "content": "Для наглядного закрепления CSS Grid, работы с колонками, строками, областями (grid-template-areas) и создания адаптивных сеток рекомендуем видеоматериал:\n\n- **[Grid CSS полный курс за 13 минут. Все свойства (YouTube)](https://youtu.be/MEOR2b69Pl4?si=yw0WgI6B-Me1fTFa)** — быстрый и подробный практический курс от Ulbi TV: все свойства Grid-контейнера и grid-элементов за 13 минут на наглядных примерах."
        }
      ],
      "seniorTips": [
      ...
      "questions": [
        {
          ...
          "options": [
            "Flexbox работает исключительно с текстом и шрифтами",
            "Grid — двумерная система, Flexbox — одномерная",
            "Grid поддерживается только браузером Firefox",
            "Grid устарел и заменён на float-верстку"
          ],
          "correctIndex": 1,
          "explanation": "Flexbox управляет элементами вдоль одной оси, а Grid создаёт двумерную матрицу строк и столбцов одновременно."
        },
        {
          "id": "css11-q2",
          "question": "Что означает единица измерения 1fr в CSS Grid?",
          "options": [
            "Один кадр анимации в секунду при рендеринге",
            "Один физический миллиметр на экране устройства",
            "Доля свободного места после фиксированных треков и gap",
            "Ровно сто пикселей ширины колонки сетки"
          ],
          "correctIndex": 2,
          "explanation": "1fr — одна доля свободного пространства: две колонки по 1fr разделят доступное место поровну."
        },
        {
          "id": "css11-q3",
          "question": "Как работает формула grid-template-columns: repeat(auto-fit, minmax(280px, 1fr));?",
          "options": [
            "Создаёт ровно 280 колонок в сетке контейнера",
            "Считает максимум колонок по 280px и тянет их на всю ширину",
            "Полностью отключает адаптивность у контейнера сетки",
            "Фиксирует ширину экрана устройства на 280 пикселях"
          ],
          "correctIndex": 1,
          "explanation": "auto-fit динамически подбирает количество колонок под ширину экрана: 1 на мобилке, 2 на планшете, 6 на 4K — без @media."
        },
        {
          "id": "css11-q4",
          "question": "В чём разница между auto-fit и auto-fill при малом количестве элементов?",
          "options": [
            "Между этими ключевыми словами нет никакой разницы",
            "Ключевое слово auto-fill запрещено спецификацией W3C",
            "Ключевое слово auto-fit не работает с функцией minmax",
            "auto-fit схлопывает пустые треки, auto-fill их сохраняет"
          ],
          "correctIndex": 3,
          "explanation": "На широком экране auto-fit растянет две карточки на всю ширину, а auto-fill оставит пустые слоты справа."
        },
        {
          "id": "css11-q5",
          "question": "Какое свойство задаёт высоту автоматически создаваемых строк неявной сетки?",
          "options": [
            "grid-auto-rows",
            "implicit-height",
            "row-auto-size",
          ...
          "correctIndex": 0,
          "explanation": "grid-auto-rows определяет размер строк, которые браузер генерирует сверх объявленных в grid-template-rows."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css12-q1",
          "question": "Какое главное правило нужно соблюдать при составлении схемы grid-template-areas?",
          "options": [
            "Названия областей пишутся только заглавными буквами",
            "Каждая строка схемы содержит равное число ячеек",
            "Схема не может содержать больше трёх строк подряд",
            "Символ точки в схеме строго запрещён стандартом"
          ],
          "correctIndex": 1,
          "explanation": "Спецификация требует строгой прямоугольной матрицы, а все именованные области должны быть прямоугольными."
        },
        {
          "id": "css12-q2",
          "question": "Что делает запись grid-column: 1 / -1; на элементе сетки?",
          "options": [
            "Скрывает элемент сетки с экрана пользователя",
            "Уменьшает размер элемента ровно на один пиксель",
            "Растягивает элемент от первой до последней линии",
            "Перемещает элемент в левый верхний угол сетки"
          ],
          "correctIndex": 2,
          "explanation": "Индекс -1 указывает на последнюю линию сетки, поэтому блок занимает 100% ширины колонок."
        },
        {
          "id": "css12-q3",
          "question": "В чём преимущество Grid Overlap перед position: absolute для текста поверх картинки?",
          "options": [
            "Grid Overlap не поддерживается браузером Safari",
            "Grid Overlap умеет автоматически анимировать слои",
            "Между этими двумя подходами разницы нет",
            "absolute схлопывает высоту, Grid сохраняет её"
          ],
          "correctIndex": 3,
          "explanation": "absolute вырывает элемент из потока и ломает геометрию, а Grid Overlap держит слои в ячейке и вычисляет высоту корректно."
        },
        {
          "id": "css12-q4",
          "question": "Что делает свойство grid-auto-flow: dense?",
          "options": [
            "Плотно заполняет пустые дыры мелкими элементами",
            "Увеличивает плотность пикселей на дисплее Retina",
            "Полностью запрещает перенос элементов на строку",
            "Сжимает изображения внутри ячеек сетки"
          ],
          "correctIndex": 0,
          "explanation": "dense устраняет пустоты от переноса крупных элементов span 2, подтягивая на их место компактные ячейки."
        },
        {
          "id": "css12-q5",
          "question": "Что означает символ точки '.' в свойстве grid-template-areas?",
          "options": [
            "Синтаксическая ошибка в описании схемы сетки",
            "Пустая незаполненная ячейка (пропуск) в сетке",
            "Точка останова адаптивности внутри сетки",
            "Признак конца строки в описании областей"
          ],
          "correctIndex": 1,
          "explanation": "Точка служит заполнителем для ячеек, в которые не привязывается ни одна именованная область."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css13-q1",
          "question": "В чём главное отличие Mobile First от Desktop First?",
          "options": [
            "Mobile First использует медиа-запросы с max-width",
            "Mobile First запрещает применять CSS Grid в проекте",
            "Между этими подходами нет практической разницы",
            "Mobile First пишет базу для мобилок, расширяя min-width"
          ],
          "correctIndex": 3,
          "explanation": "Mobile First: базовый CSS для мобильных, усложнение через min-width. Desktop First делает наоборот и расточительно нагружает мобилки."
        },
        {
          "id": "css13-q2",
          "question": "Что делает CSS-функция clamp(1rem, 3vw, 2rem)?",
          "options": [
            "Плавно масштабирует между 1rem и 2rem, используя 3vw",
            "Устанавливает жёстко фиксированный размер в 3vw",
            "Обрезает текст, не помещающийся в контейнер",
            "Всегда устанавливает размер ровно в 1rem"
          ],
          "correctIndex": 0,
          "explanation": "clamp ограничивает значение диапазоном [MIN, MAX], используя PREFERRED для плавного масштабирования."
        },
        {
          "id": "css13-q3",
          "question": "Почему на мобильных устройствах рекомендуется 100dvh вместо 100vh?",
          "options": [
            "Единица dvh обрабатывается браузером заметно быстрее",
            "100vh в Safari включает зону адресной строки",
            "Единица dvh поддерживается только в Chrome",
            "Между vh и dvh нет практической разницы"
          ],
          "correctIndex": 1,
          "explanation": "100vh считает полную высоту вместе с зоной скрывающейся адресной строки, а 100dvh — только видимую часть."
        },
        {
          "id": "css13-q4",
          "question": "Чем Container Queries принципиально отличаются от Media Queries?",
          "options": [
            "Container Queries работают заметно быстрее @media",
            "Container Queries требуют подключения JavaScript",
            "Container Queries смотрят на ширину контейнера, не окна",
            "Между @container и @media нет никакой разницы"
          ],
          "correctIndex": 2,
          "explanation": "Компонент адаптируется к размеру своего контейнера, что делает его по-настоящему переиспользуемым в разных контекстах."
        },
        {
          "id": "css13-q5",
          "question": "Зачем нужен meta-тег viewport width=device-width, initial-scale=1?",
          "options": [
            "Подключает внешние скрипты JavaScript к странице",
            "Управляет анимациями и переходами на странице",
            "Подключает пользовательские веб-шрифты к странице",
            "Заставляет браузер использовать реальную ширину экрана"
          ],
          "correctIndex": 3,
          "explanation": "Без viewport meta мобильные браузеры рендерят страницу в виртуальном окне ~980px и масштабируют её, делая текст нечитаемым."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css14-q1",
          "question": "В чём фундаментальное отличие CSS Custom Properties от переменных Sass?",
          "options": [
            "CSS-переменные работают только со значениями цветов",
            "Sass считается на сборке, CSS-переменные живут в рантайме",
            "Sass поддерживает fallback, а CSS-переменные — нет",
            "Между этими двумя видами переменных нет разницы"
          ],
          "correctIndex": 1,
          "explanation": "CSS Custom Properties подчиняются каскаду DOM и меняются из JavaScript без пересборки стилей."
        },
        {
          "id": "css14-q2",
          "question": "Что произойдёт при color: var(--brand-color, #2dff8a), если переменная не объявлена?",
          "options": [
            "Свойство color будет полностью проигнорировано",
            "Браузер выведет ошибку парсинга в консоль",
            "Применится запасное значение #2dff8a из второго аргумента",
            "Текст элемента станет полностью прозрачным"
          ],
          "correctIndex": 2,
          "explanation": "Второй аргумент var() служит fallback-значением при отсутствии объявленной переменной."
        },
        {
          "id": "css14-q3",
          "question": "Как из JavaScript изменить значение глобальной CSS-переменной?",
          "options": [
          ...
          "correctIndex": 3,
          "explanation": "setProperty на documentElement устанавливает значение переменной на корневом элементе <html> (:root)."
        },
        {
          "id": "css14-q4",
          "question": "Какой селектор является стандартом для объявления темы в современных приложениях?",
          "options": [
            "Атрибут [data-theme=\"dark\"] на корневом теге html",
            "Класс .dark-theme-all-elements на каждом элементе",
            "Идентификатор #dark на теге body документа",
            "Директива @dark в начале файла стилей"
          ],
          "correctIndex": 0,
          "explanation": "data-атрибут на <html> позволяет переключать тему одной строчкой JS без коллизий классов."
        },
        {
          "id": "css14-q5",
          "question": "Чувствительны ли имена CSS Custom Properties к регистру символов?",
          "options": [
            "Нет, регистр символов в именах не имеет значения",
            "Да, --primary-color и --Primary-Color различаются",
            "Регистр важен только в браузере Safari на iOS",
            "Регистр важен только для переменных внутри :root"
          ],
          "correctIndex": 1,
          "explanation": "В отличие от обычных CSS-свойств, пользовательские переменные строго чувствительны к регистру."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css15-q1",
          "question": "Почему анимации на transform плавнее, чем анимации top/left/margin?",
          "options": [
            "Свойство transform реализовано на языке C++",
            "Свойство transform работает только в Chromium",
            "transform считается на GPU и не вызывает Reflow",
            "Разницы в производительности между ними нет"
          ],
          "correctIndex": 2,
          "explanation": "transform и opacity не влияют на геометрию соседей, поэтому браузер анимирует их на GPU с частотой 60–120 FPS."
        },
        {
          "id": "css15-q2",
          "question": "От чего вычисляются проценты в записи transform: translate(-50%, -50%)?",
          "options": [
            "От ширины и высоты родительского контейнера",
            "От собственных ширины и высоты элемента",
            "От размеров окна браузера (viewport)",
            "От текущего размера шрифта элемента"
          ],
          "correctIndex": 1,
          "explanation": "В отличие от top/left, translate берёт 50% от собственного размера элемента — идеально для центрирования."
        },
        {
          "id": "css15-q3",
          "question": "Зачем нужно свойство backface-visibility: hidden при создании 3D Card Flip?",
          "options": [
            "Ускоряет загрузку картинок внутри карточки",
            "Отключает вертикальную прокрутку всей страницы",
            "Удаляет тень, отбрасываемую карточкой на фон",
            "Скрывает изнанку грани, повёрнутой от зрителя"
          ],
          "correctIndex": 3,
          "explanation": "Свойство скрывает грань, когда нормаль её плоскости направлена от зрителя, предотвращая наложение перевёрнутого текста."
        },
        {
          "id": "css15-q4",
          "question": "Что произойдёт при изменении perspective на родителе с 1500px до 300px?",
          "options": [
            "Элемент станет полностью невидимым на экране",
            "3D-искажение станет сильнее: камера ближе к объекту",
            "Элемент уменьшится в размерах ровно в пять раз",
            "Ничего не изменится в отображении элемента"
          ],
          "correctIndex": 1,
          "explanation": "perspective задаёт дистанцию от зрителя до плоскости Z=0: чем меньше значение, тем выраженнее перспектива."
        },
        {
          "id": "css15-q5",
          "question": "Что делает свойство transform-origin: top left;?",
          "options": [
            "Задаёт точку привязки для поворота и масштабирования",
            "Перемещает элемент в левый верхний угол экрана",
            "Обрезает левый верхний угол блока по диагонали",
            "Полностью удаляет скругление углов элемента"
          ],
          "correctIndex": 0,
          "explanation": "transform-origin определяет центр трансформации: по умолчанию 50% 50%, но его можно сместить в любую точку."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css16-q1",
          "question": "Почему запись transition: all 0.3s считается антипаттерном?",
          "options": [
            "Значение all работает только в старых браузерах",
            "Значение all полностью отключает ускорение на GPU",
            "all отслеживает все свойства и провоцирует Reflow",
            "Значение all не поддерживается браузером Chrome"
          ],
          "correctIndex": 2,
          "explanation": "Явное перечисление свойств предотвращает случайный запуск тяжёлых Reflow-анимаций при изменении геометрии."
        },
        {
          "id": "css16-q2",
          "question": "Какой эффект создаёт кривая cubic-bezier(0.34, 1.56, 0.64, 1) с параметром y2 больше 1?",
          "options": [
            "Мгновенное переключение состояний без анимации",
            "Полная остановка анимации ровно на середине пути",
            "Замедление всей анимации примерно в десять раз",
            "Упругий отскок: элемент перелетает и пружинит назад"
          ],
          "correctIndex": 3,
          "explanation": "Координата Y > 1 выходит за пределы 100% трансформации, создавая пружинящий овершут."
        },
        {
          "id": "css16-q3",
          "question": "Какая функция плавности является стандартом для ПОЯВЛЕНИЯ меню, модалок и тултипов?",
          "options": [
            "linear — постоянная скорость на всём протяжении",
            "ease-out — быстрый старт и мягкое торможение",
            "ease-in — медленный старт с разгоном к финишу",
            "steps(5) — пять дискретных шагов без сглаживания"
          ],
          "correctIndex": 1,
          "explanation": "ease-out немедленно реагирует на действие пользователя и плавно останавливается, создавая ощущение отзывчивости."
        },
        {
          "id": "css16-q4",
          "question": "Для чего используется transition-delay в технике Staggered Animation?",
          "options": [
            "Полностью удаляет элементы списка из DOM-дерева",
            "Ускоряет анимацию появления каждого элемента",
            "Даёт нарастающую задержку, создавая каскадную волну",
            "Включает трёхмерный режим отображения элементов"
          ],
          "correctIndex": 2,
          "explanation": "Каскадные задержки (50ms, 100ms, 150ms) заставляют элементы списка появляться по очереди друг за другом."
        },
        {
          "id": "css16-q5",
          "question": "Как реализовать плавное появление модалки, если display: none не поддерживает transition?",
          "options": [
            "Связка opacity, visibility и pointer-events с переходом",
            "Ручной таймер на JavaScript в цикле while",
            "Плавное изменение ширины элемента до нуля пикселей",
            "Средствами CSS это сделать принципиально невозможно"
          ],
          "correctIndex": 0,
          "explanation": "opacity + visibility: hidden исключает элемент из кликов и дерева доступности, сохраняя плавную интерполяцию."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css17-q1",
          "question": "Что произойдёт после однократной анимации, если animation-fill-mode не указан?",
          "options": [
            "Элемент навсегда сохранит стили последнего кадра",
            "Элемент мгновенно вернётся к исходным стилям в CSS",
            "Элемент будет удалён из DOM-дерева документа",
            "Страница автоматически перезагрузится в браузере"
          ],
          "correctIndex": 1,
          "explanation": "По умолчанию (fill-mode: none) анимация влияет на элемент только во время воспроизведения — для фиксации нужен forwards."
        },
        {
          "id": "css17-q2",
          "question": "Какое значение animation-play-state ставит бесконечную анимацию на паузу?",
          "options": [
            "stop",
            "freeze",
            "paused",
        ...
        {
          "id": "css17-q3",
          "question": "Какое событие JavaScript срабатывает при полном завершении CSS-анимации?",
          "options": [
            "onfinish",
            "csscomplete",
            "transitionclose",
          ...
          "correctIndex": 3,
          "explanation": "animationend стреляет в DOM-элементе в момент окончания анимации, что позволяет безопасно удалить узел."
        },
        {
          "id": "css17-q4",
          "question": "Что делает значение animation-direction: alternate?",
          "options": [
            "Чётные циклы идут вперёд, нечётные — назад",
            "Воспроизводит кадры анимации в случайном порядке",
            "Ускоряет воспроизведение анимации примерно вдвое",
            "Инвертирует цвета элемента на каждом цикле"
          ],
          "correctIndex": 0,
          "explanation": "alternate разворачивает направление на каждом втором цикле, исключая резкий скачок между 100% и 0%."
        },
        {
          "id": "css17-q5",
          "question": "Зачем в CSS обязателен медиа-запрос @media (prefers-reduced-motion: reduce)?",
          "options": [
            "Экономит мобильный интернет-трафик пользователя",
            "Обеспечивает поддержку старых версий Internet Explorer",
            "Защищает людей с вестибулярными расстройствами",
            "Полностью отключает исполнение JavaScript на странице"
          ],
          "correctIndex": 2,
          "explanation": "Фича сообщает сайту, что пользователь отключил анимации движения в настройках ОС ради комфорта и здоровья."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            "Работает исключительно в браузере Mozilla Firefox",
            "Показывает кольцо только при навигации с клавиатуры",
            "Полностью отключает фокус у интерактивных элементов",
            "Удаляет сфокусированный элемент из DOM-дерева"
          ],
          "correctIndex": 1,
          "explanation": ":focus-visible убирает некрасивое кольцо при клике мышью, сохраняя доступность для клавиатурных пользователей."
        },
        {
          "id": "css18-q2",
          "question": "Что делает селектор form:has(input:invalid)?",
          "options": [
            "Удаляет форму со страницы при ошибке валидации",
            "Добавляет новое поле ввода внутрь формы",
            "Стилизует родительскую форму по состоянию потомка",
            "Полностью отключает нативную валидацию полей"
          ],
          "correctIndex": 2,
          "explanation": ":has() позволяет проверять потомков и применять стили к элементу-предку — революционная возможность CSS Level 4."
        },
        {
          "id": "css18-q3",
          "question": "Какое свойство обязательно для отрисовки псевдоэлементов ::before и ::after?",
          "options": [
            "display: block",
            "position: absolute",
            "z-index: 1",
            "content (например, content: '')"
          ],
          "correctIndex": 3,
          "explanation": "Без свойства content псевдоэлемент не генерируется браузером вообще."
        },
        {
          "id": "css18-q4",
          "question": "Почему ::before и ::after НЕ работают на элементах <img>, <input> и <br>?",
          "options": [
            "Это баг Chrome, который скоро будет исправлен",
            "Нужно использовать три двоеточия вместо двух",
            "Замещаемые элементы не имеют дочернего содержимого",
            "Они работают, но требуют z-index: 9999 и position"
          ],
          "correctIndex": 2,
          "explanation": "Замещаемые элементы рендерятся как атомарные блоки без внутренней DOM-структуры, поэтому вставить узел некуда."
        },
        {
          "id": "css18-q5",
          "question": "В чём разница между :is() и :where() при группировке селекторов?",
          "options": [
            "Между этими псевдоклассами нет никакой разницы",
            "Псевдокласс :where() работает только в Safari",
            "Псевдокласс :is() удаляет несовпавшие элементы",
            ":is() хранит специфичность аргумента, :where() — ноль"
          ],
          "correctIndex": 3,
          "explanation": ":where() с нулевой специфичностью идеален для CSS Reset, который легко переопределить пользовательскими стилями."
        }
      ]
    }
  },
  {
    ...
    "moduleId": "css",
    "level": 19,
    "title": "Математические функции CSS: clamp(), min(), max(), calc() и Fluid Typography",
    "subtitle": "Адаптивная верстка без медиа-запросов: fluid типографика, адаптивные отступы, сравнение min/max и математика динамических интерфейсов",
    "description": "Освойте современную математику в CSS: возможности и синтаксические ловушки функции calc(), установку верхней и нижней границ через min() и max(), динамическое масштабирование через clamp(), формулу Fluid Typography для плавного изменения размеров шрифта от мобильных до 4K мониторов без ступенчатых медиа-запросов.",
    "estimatedMinutes": 65,
    "difficulty": "advanced",
    "tags": [
      "css-math",
    ...
    "theory": {
      "overview": "Раньше для создания адаптивного дизайна верстальщики писали десятки ступенчатых медиа-запросов (`@media (min-width: 768px)`, `@media (min-width: 1024px)`...). На каждом брейкпоинте шрифты и отступы резко «прыгали» в размере.\n\nСовременные математические функции CSS — **`clamp()`**, **`min()`**, **`max()`** и **`calc()`** — совершили революцию в адаптивности: они позволяют создавать **по-настоящему плавный дизайн (Fluid Responsive Design)**, где размеры элементов непрерывно и пропорционально подстраиваются под любой экран от Apple Watch до 4K-монитора без единого `@media`!\n\nВ этом уроке мы разберём математику этих функций и научимся проектировать флюидные системы.",
      "sections": [
        {
          "title": "Функция calc(): смешивание единиц и критическое правило пробелов",
          "content": "Возможности вычислений в CSS:\n\n1. **Смешивание разнородных единиц измерения**:\n- Главная сила `calc()` — возможность комбинировать фиксированные и относительные величины: пиксели, проценты, viewport-единицы и rem:\n  `width: calc(100% - 40px);`\n  `height: calc(100vh - 80px);` (высота экрана минус шапка сайта).\n\n2. **Критическое синтаксическое правило пробелов ⚠️**:\n- Операторы сложения `+` и вычитания `-` **ОБЯЗАТЕЛЬНО должны быть отделены пробелами с обеих сторон**!\n- `calc(100% - 20px)` — ✅ Корректно.\n- `calc(100%-20px)` — ❌ Синтаксическая ошибка! Браузер воспримет `-20px` как отрицательное число и проигнорирует всё свойство.\n- Для умножения `*` и деления `/` пробелы не обязательны, но рекомендуются для читаемости.",
          "image": {
            "src": "/images/lessons/css-math-clamp-calc.svg",
            "alt": "CSS Математические функции clamp, min, max, calc и Fluid Typography",
            "caption": "Сравнение min(), max(), синтаксис clamp(MIN, PREFERRED, MAX) и плавная типографика Fluid Typography"
          },
          "codeExample": {
            "language": "css",
            "code": "/* Расчет высоты главного экрана за вычетом фиксированного хедера (70px) и паддингов */\n.hero-section {\n  /* 100vh минус хедер и отступы */\n  min-height: calc(100vh - 70px - 2rem);\n  \n  /* Расчет ширины колонок в сетке с учетом зазора */\n  width: calc((100% - 3 * 16px) / 4);\n  \n  /* Вложенные расчеты calc() поддерживаются нативно */\n  padding: calc(1rem + 2 * (100vw - 320px) / (1200 - 320));\n}\n\n/* ❌ Ошибка: отсутствие пробелов вокруг минуса ломает свойство! */\n/* .bad-example { width: calc(100%-40px); } */",
            "title": "Использование calc() со смешиванием vh, rem, px и процентов",
            "explanation": "calc() динамически высчитывает точные размеры прямо в браузере при любом изменении размеров окна."
          }
        },
        {
          "title": "Функции min() и max(): ограничение диапазонов",
          "content": "Интуиция работы функций `min()` и `max()` в CSS:\n\n1. **`min(значение1, значение2, ...)` — Задает ВЕРХНЮЮ границу (Потолок)**:\n- Функция возвращает **наименьшее** из переданных значений.\n- **Современный эталон адаптивного контейнера**:\n  `width: min(100% - 32px, 1200px);`\n  - На смартфоне (`width < 1200px`): `100% - 32px` меньше, чем `1200px` → ширина равна `100% - 32px` (с боковыми полями 16px).\n  - На широком мониторе: `1200px` меньше, чем `100% - 32px` → ширина зафиксирована на `1200px`!\n  - Заменяет связку `width: 100%; max-width: 1200px; padding: 0 16px;` в **одну строчку кода**!\n\n2. **`max(значение1, значение2, ...)` — Задает НИЖНЮЮ границу (Пол)**:\n- Возвращает **наибольшее** из значений.\n- `padding: max(16px, 4vw);` — отступ динамически растет с шириной экрана (4vw), но **никогда не станет меньше 16px** даже на самом узком экране смартфона.",
          "codeExample": {
            "language": "css",
            "code": "/* Современный центрированный контейнер в 2 строки без медиа-запросов */\n.modern-container {\n  /* Ширина: 100% минус боковые отступы на мобилке, но не более 1280px на десктопе */\n  width: min(100% - 32px, 1280px);\n  margin-inline: auto;\n}\n\n/* Безопасные отступы секции: динамические 5vw, но не менее 24px */\n.section-wrapper {\n  padding-block: max(24px, 5vw);\n}",
            "title": "Адаптивный контейнер через min() и безопасный отступ через max()",
            "explanation": "min() устанавливает верхний предел ширины контента, а max() предотвращает чрезмерное сжатие отступов на мобильных."
          }
        },
        {
          "title": "Функция clamp(): 3 параметра и идеальный баланс",
          "content": "Как устроена функция `clamp(MIN, PREFERRED, MAX)`:\n\n1. **Синтаксис**:\n- `MIN` (Минимум) — нижний предел (пол), ниже которого значение не опустится.\n- `PREFERRED` (Желаемое значение) — динамическое плавающее значение (обычно с `vw` или `rem`).\n- `MAX` (Максимум) — верхний предел (потолок), выше которого значение не поднимется.\n\n2. **Эквивалент через max и min**:\n- Запись `clamp(16px, 4vw, 40px)` абсолютно эквивалентна `max(16px, min(4vw, 40px))`.\n\n3. **Внутри `clamp()`, `min()`, `max()` не нужен `calc()`**:\n- Математические операторы `+`, `-`, `*`, `/` вычисляются внутри этих функций автоматически:\n  `font-size: clamp(1rem, 0.8rem + 1.5vw, 2.5rem);` — валидный и чистый синтаксис!",
          "codeExample": {
            "language": "css",
            "code": "/* Динамический размер карточки: от 280px до 420px */\n.responsive-card {\n  width: clamp(280px, 30vw, 420px);\n  \n  /* Динамические внутренние отступы карточки */\n  padding: clamp(16px, 2.5vw, 32px);\n  \n  /* Динамический радиус скругления углов */\n  border-radius: clamp(8px, 1.2vw, 16px);\n  \n  background: #161b22;\n  border: 1px solid #30363d;\n}",
            "title": "Плавное масштабирование ширины, паддингов и скруглений карточки",
            "explanation": "clamp() удерживает размеры в строгих границах безопасности, плавно интерполируя промежуточные значения."
          }
        },
        {
          "title": "Fluid Typography (Плавная типографика) на практике",
          "content": "Математика идеального шрифта без ступенчатых медиа-запросов:\n\n1. **Проблема традиционной верстки**:\n- На мобильном `h1 = 24px`, на планшете `h1 = 36px`, на десктопе `h1 = 56px`.\n- При ресайзе окна шрифт резко «прыгает» в размерах на каждом брейкпоинте.\n\n2. **Формула Fluid Typography**:\n- Используем базовый размер в `rem` плюс динамическую добавку в `vw`:\n  `h1 { font-size: clamp(1.75rem, 1.2rem + 2.5vw, 3.5rem); }`\n- **На смартфонах (320px)**: `font-size` зафиксирован на `1.75rem` (28px) — текст не вылезает за экран.\n- **На планшетах и ноутбуках**: размер плавно и непрерывно масштабируется пиксель за пикселем.\n- **На 4K мониторах (> 2000px)**: зафиксирован на `3.5rem` (56px) — заголовок не раздувается до гигантских размеров!",
          "codeExample": {
            "language": "css",
            "code": "/* Полная дизайн-система плавной типографики (Fluid Typography Scale) */\n:root {\n  /* Основной текст: от 15px до 18px */\n  --text-base: clamp(0.9375rem, 0.9rem + 0.2vw, 1.125rem);\n  \n  /* Подзаголовки h3: от 18px до 24px */\n  --text-h3: clamp(1.125rem, 1rem + 0.6vw, 1.5rem);\n  \n  /* Заголовки секций h2: от 22px до 36px */\n  --text-h2: clamp(1.375rem, 1.1rem + 1.4vw, 2.25rem);\n  \n  /* Главные заголовки h1: от 28px до 56px */\n  --text-h1: clamp(1.75rem, 1.2rem + 2.5vw, 3.5rem);\n  \n  /* Флюидный межэлементный зазор (Gap) */\n  --space-grid: clamp(16px, 2vw + 8px, 48px);\n}\n\nh1 { font-size: var(--text-h1); line-height: 1.15; }\nh2 { font-size: var(--text-h2); line-height: 1.25; }\np  { font-size: var(--text-base); line-height: 1.6; }\n\n.catalog-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  gap: var(--space-grid);\n}",
            "title": "Дизайн-система Fluid Typography на CSS Custom Properties",
            "explanation": "Все уровни типографики и отступы сетки масштабируются согласованно и гармонично на экранах любого разрешения."
          }
        }
      ],
      "seniorTips": [
        "При создании Fluid Typography никогда не используйте чистый `vw` без базы в `rem` (например, `font-size: 3vw`), иначе пользователи с нарушением зрения не смогут увеличить шрифт в настройках браузера (нарушение критериев WCAG). Всегда пишите `clamp(1rem, 0.8rem + 1.5vw, 2.5rem)`.",
        "Внутри функций `min()`, `max()` и `clamp()` не нужно писать `calc()` — выражения вычисляются автоматически.",
        "Замените устаревшую конструкцию `width: 100%; max-width: 1200px; padding: 0 16px; margin: 0 auto;` на современную: `width: min(100% - 32px, 1200px); margin-inline: auto;`.",
        "Помните о пробелах в `calc()`: `calc(100% - 20px)` работает, а `calc(100%-20px)` полностью ломает рендеринг свойства."
      ],
      "commonMistakes": [
        {
          "bad": "/* calc без пробелов вокруг операторов */\n.sidebar { width: calc(100%-250px); /* ❌ Браузер бракует всё свойство! */ }",
          "good": ".sidebar { width: calc(100% - 250px); }",
          "reason": "Спецификация CSS требует пробелов вокруг операторов + и -, чтобы не путать их со знаками отрицательных величин."
        },
        {
          "bad": "/* Использование чистого vw для размера шрифта */\nh1 { font-size: 5vw; /* ❌ На мобильном 320px шрифт станет 16px (микроскопический), а на 4K — 192px! */ }",
          "good": "h1 { font-size: clamp(1.75rem, 1.2rem + 2.5vw, 3.5rem); }",
          "reason": "Чистый vw не имеет ограничений минимума и максимума и ломает масштабирование для слабовидящих людей."
        },
        {
          "bad": "/* Избыточная вложенность calc() внутри clamp() */\nh1 { font-size: clamp(16px, calc(1rem + 2vw), 32px); }",
          "good": "h1 { font-size: clamp(16px, 1rem + 2vw, 32px); }",
          "reason": "Функции clamp(), min() и max() уже умеют выполнять математические операции без вызова calc()."
        }
      ],
      "keyTakeaways": [
        "calc() смешивает разнородные единицы, но требует обязательных пробелов вокруг + и -.",
        "min() задает верхнюю границу (потолок), max() — нижнюю границу (пол).",
        "clamp(MIN, PREFERRED, MAX) удерживает значение в безопасном диапазоне.",
        "Fluid Typography масштабирует текст плавно без резких скачков медиа-запросов.",
        "width: min(100% - 32px, 1200px) создает идеальный адаптивный контейнер в одну строку."
      ]
    },
    "sandbox": {
      "initialHtml": "<div class=\"fluid-sandbox\">\n  <h1 class=\"fluid-title\">Fluid Typography ⚡</h1>\n  <p class=\"fluid-desc\">Этот заголовок плавно масштабируется от 20px до 48px в зависимости от ширины экрана без единого @media query!</p>\n  <div class=\"fluid-box\">\n    <span>Контейнер: width: min(100% - 32px, 600px)</span>\n  </div>\n</div>",
      "initialCss": ".fluid-sandbox { padding: 20px; background: #0a0e13; font-family: monospace; color: #e6edf3; }\n.fluid-title {\n  font-size: clamp(1.25rem, 1rem + 2.5vw, 3rem);\n  color: #2dff8a;\n  line-height: 1.2;\n  margin-bottom: 12px;\n}\n.fluid-desc {\n  font-size: clamp(0.875rem, 0.8rem + 0.5vw, 1.125rem);\n  color: #8b949e;\n  line-height: 1.6;\n  margin-bottom: 20px;\n}\n.fluid-box {\n  width: min(100% - 32px, 600px);\n  padding: clamp(12px, 2vw, 24px);\n  background: #161b22;\n  border: 1px solid #29e7ff;\n  border-radius: clamp(6px, 1vw, 12px);\n  text-align: center;\n}",
      "initialJs": "console.log('Fluid Math песочница готова');",
      "instructions": "Практика с clamp() и min():\n1. Изменяйте размер окна браузера или ширину контейнера\n2. Наблюдайте, как размер шрифта плавно и непрерывно масштабируется без рывков\n3. Блок fluid-box адаптируется по формуле min(100% - 32px, 600px)"
    },
    "task": {
      "title": "Разработка флюидной адаптивной карточки профиля на clamp(), min() и calc()",
      "scenario": "Создайте адаптивную карточку пользователя без единого медиа-запроса @media: ширина карточки должна вычисляться через min(100% - 24px, 480px) с центрированием, размер аватара должен быть clamp(60px, 8vw, 100px), заголовок имени — clamp(1.25rem, 1rem + 1.5vw, 2rem), а внутренние отступы — clamp(16px, 3vw, 32px).",
      "criteria": [
        "Карточка использует width: min(100% - 24px, 480px) и margin-inline: auto",
        "Аватар масштабируется через clamp(60px, 8vw, 100px) для ширины и высоты",
        "Заголовок имени масштабируется через clamp(1.25rem, 1rem + 1.5vw, 2rem)",
        "Внутренние отступы карточки настроены через clamp(16px, 3vw, 32px)",
        "Не используются медиа-запросы @media"
      ],
      "starterCode": {
        "css": "/* Разработайте флюидную карточку без @media */\n.fluid-profile-card {\n}\n.profile-avatar {\n}\n.profile-name {\n}"
      },
      "hints": [
        ".fluid-profile-card { width: min(100% - 24px, 480px); margin-inline: auto; padding: clamp(16px, 3vw, 32px); }",
        ".profile-avatar { width: clamp(60px, 8vw, 100px); height: clamp(60px, 8vw, 100px); border-radius: 50%; }"
      ],
      "solution": {
        "css": ".fluid-profile-card {\n  width: min(100% - 24px, 480px);\n  margin-inline: auto;\n  padding: clamp(16px, 3vw, 32px);\n  background: #161b22;\n  border: 1px solid #2dff8a;\n  border-radius: clamp(8px, 1.5vw, 16px);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  gap: clamp(12px, 2vw, 20px);\n}\n\n.profile-avatar {\n  width: clamp(60px, 8vw, 100px);\n  height: clamp(60px, 8vw, 100px);\n  border-radius: 50%;\n  border: 2px solid #2dff8a;\n  object-fit: cover;\n}\n\n.profile-name {\n  font-size: clamp(1.25rem, 1rem + 1.5vw, 2rem);\n  color: #e6edf3;\n  line-height: 1.2;\n  font-weight: bold;\n}\n\n.profile-bio {\n  font-size: clamp(0.875rem, 0.8rem + 0.4vw, 1rem);\n  color: #8b949e;\n  line-height: 1.5;\n}",
        "explanation": "Все элементы карточки (размеры, аватар, шрифты, зазоры) непрерывно и пропорционально масштабируются на экранах любой ширины."
      }
    },
    "quiz": {
      "questions": [
        {
          "id": "css19-q1",
          "question": "Какая распространённая синтаксическая ошибка делает функцию calc() недействительной?",
          "options": [
            "Применение дробных числовых значений в выражении",
            "Отсутствие пробелов вокруг операторов + и −",
            "Использование процентных значений внутри calc()",
            "Использование пикселей вместе с процентами"
          ],
          "correctIndex": 1,
          "explanation": "Спецификация требует пробелов вокруг + и −, чтобы отличать их от отрицательных числовых значений."
        },
        {
          "id": "css19-q2",
          "question": "Как работает выражение width: min(100% - 32px, 1200px)?",
          "options": [
            "Ширина всегда равна фиксированным 1200 пикселям",
            "Ширина всегда равна ста процентам контейнера",
            "Берётся меньшее: 100% − 32px на мобилке, 1200px на десктопе",
            "Такая запись является синтаксической ошибкой"
          ],
          "correctIndex": 2,
          "explanation": "min() выбирает наименьшее значение, компактно заменяя связку width: 100% и max-width: 1200px."
        },
        {
          "id": "css19-q3",
          "question": "Что означают три аргумента в функции clamp(MIN, PREFERRED, MAX)?",
          "options": [
            "Красный, зелёный и синий каналы цвета",
            "Начало, середина и конец кривой анимации",
            "Ширина, высота и глубина трёхмерного блока",
            "Минимум, желаемое значение и максимум"
          ],
          "correctIndex": 3,
          "explanation": "clamp удерживает плавающее желаемое значение строго в рамках от MIN до MAX."
        },
        {
          "id": "css19-q4",
          "question": "Почему для Fluid Typography нельзя использовать только чистые vw (например, font-size: 4vw)?",
          "options": [
            "Единица vw не поддерживается мобильными браузерами",
            "Чистый vw без границ ломает зум и доступность",
            "Единица vw применима только к изображениям",
            "Единица vw запрещена спецификацией W3C"
          ],
          "correctIndex": 1,
          "explanation": "Шрифт должен опираться на базовый rem: clamp(1rem, 0.8rem + 1.5vw, 2.5rem) сохраняет масштабирование настроек браузера."
        },
        {
          "id": "css19-q5",
          "question": "Нужно ли оборачивать выражения внутри clamp(), min() и max() в calc()?",
          "options": [
            "Нет, clamp(), min() и max() считают выражения сами",
            "Да, оборачивать в calc() нужно всегда",
            "Только при выполнении операций деления",
            "Только в браузере Safari на устройствах Apple"
          ],
          "correctIndex": 0,
          "explanation": "Современные математические функции CSS автоматически парсят и вычисляют выражения без вызова calc()."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css20-q1",
          "question": "Какое ключевое преимущество даёт плоская специфичность (0-1-0) в методологии БЭМ?",
          "options": [
            "Полностью убирает необходимость писать JavaScript",
            "Заметно ускоряет парсинг HTML-разметки браузером",
            "Исключает войны каскада и необходимость !important",
            "Шифрует имена классов при сборке проекта"
          ],
          "correctIndex": 2,
          "explanation": "Когда каждый селектор состоит из одного класса, переопределение свойств становится предсказуемым и тривиальным."
        },
        {
          "id": "css20-q2",
          "question": "Как CSS Modules решают проблему глобальной области видимости стилей?",
          "options": [
            "Сборщик превращает локальные классы в уникальные хеши",
            "Запрещают создавать больше пяти классов в файле",
            "Переносят все стили в атрибут style каждого тега",
            "Удаляют все дублирующиеся свойства из файла"
          ],
          "correctIndex": 0,
        ...
        {
          "id": "css20-q3",
          "question": "В чём главное отличие Zero-Runtime CSS-in-JS от Runtime-решений вроде Emotion?",
          "options": [
            "Zero-Runtime работает только в браузере Safari",
            "Zero-Runtime не поддерживает переменные и токены",
            "Zero-Runtime увеличивает JS-бандл примерно втрое",
            "Zero-Runtime компилирует стили в статический CSS"
          ],
          "correctIndex": 3,
          "explanation": "Zero-Runtime исключает исполнение стилей в браузере и полностью совместим с React Server Components."
        },
        {
          "id": "css20-q4",
          "question": "Как JIT-компилятор Tailwind CSS решает проблему размера итогового CSS?",
          "options": [
            "Удаляет неиспользуемые веб-шрифты из проекта",
            "Генерирует CSS только для реально используемых классов",
            "Уменьшает разрешение всех изображений проекта",
            "Шифрует итоговый файл стилей при сборке"
          ],
          "correctIndex": 1,
          "explanation": "JIT сканирует исходники и генерирует стили на лету, создавая бандл менее 15–20 КБ независимо от размера проекта."
        },
        {
          "id": "css20-q5",
          ...
          "options": [
            ...
            ".card_featured",
            ".card",
            ".card__nav__item__link"
          ],
          "correctIndex": 3,
          "explanation": "В БЭМ элементы всегда привязаны напрямую к блоку (block__elem). Вложенность вида block__elem1__elem2 запрещена."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "css21-q1",
          "question": "В чём главное отличие filter: drop-shadow() от свойства box-shadow?",
          "options": [
            "Функция drop-shadow работает только на смартфонах",
            "box-shadow даёт тень бокса, drop-shadow — контура",
            "Функция drop-shadow не поддерживает указание цвета",
            "Функция drop-shadow удаляет элемент из DOM-дерева"
          ],
          "correctIndex": 1,
          "explanation": "drop-shadow анализирует альфа-канал и отбрасывает тень строго по силуэту прозрачного PNG или SVG."
        },
        {
          "id": "css21-q2",
          "question": "Какое условие обязательно, чтобы эффект backdrop-filter: blur(10px) был виден?",
          "options": [
            "Фон элемента должен быть абсолютно чёрным цветом",
            "Элемент обязательно должен быть анимирован",
            "Фон элемента должен быть полупрозрачным (rgba/hsla)",
            "Аппаратное ускорение GPU нужно отключить"
          ],
          "correctIndex": 2,
          "explanation": "Непрозрачный фон полностью перекрывает подложку, и размытие backdrop-filter становится незаметным."
        },
        {
          "id": "css21-q3",
          "question": "Какой режим mix-blend-mode делает прозрачным БЕЛЫЙ фон изображения?",
          "options": [
            "screen",
            "multiply",
            "color-dodge",
          ...
          "correctIndex": 1,
          "explanation": "multiply перемножает цвета пикселей, из-за чего белые участки (значение 1.0) становятся невидимыми."
        },
        {
          "id": "css21-q4",
          "question": "Что делает CSS-свойство clip-path: polygon(...)?",
          "options": [
            "Отрисовывает трёхмерную графику средствами WebGL",
            "Сжимает вес файла изображения при загрузке",
            "Запрещает копирование текста внутри элемента",
            "Обрезает видимую область по контуру многоугольника"
          ],
          "correctIndex": 3,
          "explanation": "clip-path задаёт векторную маску обрезки любой формы прямо в CSS: наружные области прозрачны и не ловят клики."
        },
        {
          "id": "css21-q5",
          "question": "Зачем при использовании backdrop-filter дублировать свойство с префиксом -webkit-?",
          "options": [
            "Для поддержки браузера Safari на iOS и macOS",
            "Для поддержки старых версий Internet Explorer",
            "Для ускорения первичной загрузки страницы",
            "Это формальное требование валидатора W3C"
          ],
          "correctIndex": 0,
