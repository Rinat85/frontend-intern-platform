      ...
      "questions": [
        {
          ...
          "options": [
            "HyperText Markup Language — язык разметки структуры документа",
            "HighText Machine Language — компилируемый язык для веб-серверов",
            "Hyperlink Text Management Language — язык запросов к базе данных",
            "Home Tool Markup Language — формат конфигурации для сборщиков"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "AST — абстрактное синтаксическое дерево исходного кода",
            "JSON-RPC Tree — дерево удалённых процедурных вызовов",
            "DOM — объектная модель документа в памяти браузера",
            "VSS — виртуальный теневой стек отрисовки страницы"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "correctIndex": 3,
          "explanation": "Тег <img> является void-элементом. Он не имеет содержимого и закрывающего тега."
        },
        {
          "id": "h1-q4",
          "question": "Что произойдёт, если не указать директиву <!DOCTYPE html> в первой строке документа?",
          "options": [
            "Браузер вернёт фатальную ошибку и не откроет страницу",
            "Браузер включит Quirks Mode с устаревшей блочной моделью",
            "Браузер отключит весь JavaScript из соображений безопасности",
            "Браузер переключит страницу в полноэкранный режим просмотра"
          ],
          "correctIndex": 1,
          "explanation": "Без DOCTYPE включается Quirks Mode, ломающий блочную модель CSS и стандарты отображения."
        },
        {
          "id": "h1-q5",
          "question": "Зачем в теге <script> рекомендуется указывать атрибут defer при подключении в <head>?",
          "options": [
            "Скрипт выполняется только в фоновом сервис-воркере",
            "Скрипт компилируется в WebAssembly перед выполнением",
            "Скрипт грузится параллельно и стартует после сборки DOM",
            "Скрипт полностью игнорирует любые ошибки выполнения"
          ],
          "correctIndex": 2,
          "explanation": "Атрибут defer гарантирует, что скрипт скачивается параллельно с парсингом HTML и запускается после построения DOM-дерева."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            "<section> — тематический раздел с собственным заголовком",
            "<div> — универсальный контейнер без семантического смысла",
            "<article> — самодостаточная и переносимая единица контента",
            "<aside> — побочный контент, косвенно связанный с основным"
          ],
          "correctIndex": 2,
          "explanation": "<article> обозначает самодостаточный контент: пост, комментарий, карточку товара. Его можно перенести на другой сайт, и он сохранит смысл."
        },
        {
          "id": "html2-q2",
          "question": "Сколько элементов <main> допускается на одной HTML-странице?",
          "options": [
            "Ровно один видимый тег <main> на всю страницу",
            "Максимум два тега <main> на одну страницу сайта",
            "Неограниченное количество тегов <main> на странице",
            "Ни одного — тег <main> считается устаревшим"
          ],
          "correctIndex": 0,
          "explanation": "По спецификации HTML5 допускается ровно один видимый <main>, его контент должен быть уникальным для страницы."
        },
        {
          "id": "html2-q3",
          "question": "Для чего нужен атрибут `for` у элемента <label>?",
          "options": [
            "Задаёт CSS-стили для текста метки и связанного поля",
            "Определяет адрес сервера для отправки данных формы",
            "Указывает поисковым роботам ключевые слова страницы",
            "Связывает метку с полем по id и переносит на него фокус"
          ],
          "correctIndex": 3,
          "explanation": "Атрибут for связывает <label> с <input> через его id: клик по метке фокусирует поле, а скринридер озвучивает имя поля."
        },
        {
          "id": "html2-q4",
          "question": "Что произойдёт, если у <img> не указан атрибут alt?",
          "options": [
            "Изображение не будет загружено и отображено браузером",
            "Валидатор выдаст ошибку, скринридер прочтёт имя файла",
            "Браузер автоматически сгенерирует alt из имени файла",
            "Ничего не изменится: alt не влияет на работу страницы"
          ],
          "correctIndex": 1,
          "explanation": "Без alt HTML-валидатор выдаст ошибку, а скринридер озвучит путь к файлу. Для декоративных изображений используйте alt=''."
        },
        {
          "id": "html2-q5",
          ...
          "correctIndex": 2,
          "explanation": "Атрибут pattern принимает регулярное выражение и блокирует отправку формы при несоответствии маске."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "html3-q1",
          "question": "Какое сокращение Emmet сгенерирует список из трёх элементов с классом menu-item и текстом Ссылка 1, Ссылка 2, Ссылка 3?",
          "options": [
          ...
          "correctIndex": 0,
          "explanation": "Оператор '>' задаёт вложенность, '*3' тиражирует элемент, '{}' задаёт текст, а '$' подставляет порядковый номер."
        },
        {
          "id": "html3-q2",
          "question": "Что позволяет сделать панель ':hov' (Force element state) во вкладке Styles панели Chrome DevTools?",
          "options": [
            "Удалить все вычисленные стили выбранного элемента",
            "Замедлить рендеринг страницы для покадрового анализа",
            "Принудительно включить псевдоклассы :hover, :focus, :active",
            "Автоматически конвертировать CSS-правила в формат SASS"
          ],
          "correctIndex": 2,
          "explanation": "Функция ':hov' фиксирует псевдоклассы на элементе, что позволяет отлаживать меню, анимации кнопок и фокусные рамки."
        },
        {
          "id": "html3-q3",
          "question": "Что означает показатель TTFB (Time to First Byte) в шкале Network Waterfall браузера?",
          "options": [
            "Общее время полной загрузки всех ресурсов страницы",
            "Время от отправки запроса до первого байта ответа сервера",
            "Скорость отрисовки CSS-анимаций в слое композитора",
            "Время компиляции JavaScript в байт-код движком браузера"
          ],
          "correctIndex": 1,
          "explanation": "Высокий TTFB указывает на медленную обработку на бэкенде или задержки в сетевом канале."
        },
        {
          "id": "html3-q4",
          "question": "Какая команда консоли Chrome DevTools позволяет обратиться к DOM-узлу, выделенному в дереве Elements?",
          "options": [
            "$$('current')",
            "this.node",
            "document.selected",
          ...
          "correctIndex": 3,
          "explanation": "Переменная $0 ссылается на текущий выбранный элемент, а $1–$3 — на ранее выбранные узлы."
        },
        {
          "id": "html3-q5",
          "question": "Для чего используется инструмент Google Lighthouse в Chrome DevTools?",
          "options": [
            "Проверяет орфографию и грамматику текста на странице",
            "Аудит производительности, доступности, SEO и Best Practices",
            "Генерирует надёжные пароли для форм авторизации",
            "Блокирует рекламные баннеры и сторонние трекеры"
          ],
          "correctIndex": 1,
          "explanation": "Lighthouse проводит автоматизированный аудит по категориям Performance, Accessibility, SEO, Best Practices и PWA."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "html4-q1",
          "question": "Что произойдёт с браузерным рендерингом, если в начале HTML-файла забыть объявить <!DOCTYPE html>?",
          "options": [
            "Браузер включит Quirks Mode с блочной моделью уровня IE5",
            "Страница не загрузится и покажет пустой белый экран",
            "Браузер сам исправит ошибку без каких-либо последствий",
            "Скрипты JavaScript перестанут выполняться на странице"
          ],
          "correctIndex": 0,
          "explanation": "Без DOCTYPE активируется Quirks Mode: размеры элементов вычисляются по старой блочной модели, часть современных CSS-правил игнорируется."
        },
        {
          "id": "html4-q2",
          "question": "Почему в метатеге <meta property='og:image'> необходимо указывать строго абсолютный URL?",
          "options": [
            "Абсолютный URL всегда загружается заметно быстрее",
            "Относительные пути прямо запрещены стандартом W3C",
            "Краулеры соцсетей и мессенджеров не резолвят относительные пути",
            "Это защищает страницу от подмены изображения баннера"
          ],
          "correctIndex": 2,
          "explanation": "Боты Telegram, VK и Discord скачивают разметку вне контекста страницы, поэтому требуют полный URL с протоколом https://."
        },
        {
          "id": "html4-q3",
          "question": "Как в JavaScript получить значение атрибута у элемента <div id='card' data-user-role='admin'>?",
          "options": [
            "card.data.user_role",
          ...
          "correctIndex": 1,
          "explanation": "DataSet API конвертирует дефис-нотацию data-* в camelCase: data-user-role доступен как element.dataset.userRole."
        },
        {
          "id": "html4-q4",
          "question": "Что делает атрибут tabindex='-1' на элементе?",
          "options": [
            "Делает элемент полностью невидимым на странице",
            "Перемещает элемент в самый конец порядка навигации",
            "Блокирует обработку клика мышью по этому элементу",
            "Убирает элемент из обхода Tab, но разрешает focus() из кода"
          ],
          "correctIndex": 3,
          "explanation": "tabindex='-1' исключает элемент из естественного порядка Tab, но позволяет установить фокус программно — например, для модалок."
        },
        {
          "id": "html4-q5",
          "question": "Какое значение тега <meta name='viewport'> предотвращает автоматическое уменьшение масштаба на смартфонах?",
          "options": [
            "content='width=device-width, initial-scale=1.0'",
            "content='scale=none, zoom=disabled'",
            "content='responsive=true, mobile=1'",
            "content='mobile-first, width=auto'"
          ],
          "correctIndex": 0,
          "explanation": "Директива устанавливает ширину вьюпорта равной физической ширине экрана и базовый масштаб 1:1."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            "Тег <b> отображает текст жирнее, чем тег <strong>",
            "Оба тега полностью идентичны по смыслу и по виду",
            "<strong> передаёт важность, а <b> только выделяет визуально",
            "Тег <strong> устарел и не поддерживается браузерами"
          ],
          "correctIndex": 2,
          "explanation": "<strong> означает смысловую важность (ударение у скринридеров, вес для поисковиков), <b> привлекает внимание без семантики."
        },
        {
          "id": "html5-q2",
          ...
          "correctIndex": 3,
          "explanation": "<pre> сохраняет отступы и переносы строк, а вложенный <code> сообщает, что внутри программный код."
        },
        {
          "id": "html5-q3",
          "question": "Зачем тегу <time> необходим атрибут datetime (например, <time datetime='2026-08-19'>сегодня</time>)?",
          "options": [
            "Даёт машиночитаемую дату по стандарту ISO 8601",
            "Автоматически обновляет дату на устройстве клиента",
            "Без datetime содержимое тега <time> не отобразится",
            "Позволяет подключить CSS-стили к дате публикации"
          ],
          "correctIndex": 0,
          "explanation": "Текст внутри тега может быть относительным ('вчера'), а datetime даёт точную дату для роботов, календарей и скринридеров."
        },
        {
          "id": "html5-q4",
          "question": "Какое поведение обеспечивает тег <q> при отображении строчной цитаты?",
          "options": [
            "Делает текст цитаты полужирным начертанием",
            "Подставляет кавычки по языку из атрибута lang",
            "Переносит цитату на отдельную новую строку",
            "Скрывает цитату от индексации поисковыми роботами"
          ],
          "correctIndex": 1,
          "explanation": "Браузер сам генерирует нужные кавычки («ёлочки» для lang='ru', “лапки” для lang='en'), поэтому вручную их писать не нужно."
        },
        {
          "id": "html5-q5",
          "question": "Для чего используется тег <abbr> с атрибутом title?",
          "options": [
            "Создаёт плавную анимацию появления текста",
            "Выводит цитату из книги с указанием автора",
            "Зачёркивает неактуальный фрагмент текста",
            "Размечает аббревиатуру и даёт её расшифровку"
          ],
          "correctIndex": 3,
          "explanation": "<abbr title='HyperText Markup Language'>HTML</abbr> показывает расшифровку в подсказке и передаёт её синтезаторам речи."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "html6-q1",
          "question": "В чём заключается опасность уязвимости Tabnabbing при использовании <a href='...' target='_blank'> без атрибута rel?",
          "options": [
            "Новая страница может прочитать пароли из cookies сайта",
            "Новая страница через window.opener подменяет исходную вкладку",
            "Страница зависает и перестаёт отвечать на события ввода",
            "Такой уязвимости в современных браузерах не существует"
          ],
          "correctIndex": 1,
          "explanation": "Без rel='noopener' открывшаяся страница имеет доступ к window.opener и может скрытно перевести родительскую вкладку на фишинговый сайт."
        },
        {
          "id": "html6-q2",
          "question": "Какая комбинация атрибутов rel устраняет уязвимость Tabnabbing и скрывает реферер?",
          "options": [
            "rel='safe external'",
            "rel='nofollow hide'",
            "rel='noopener noreferrer'",
          ...
          "correctIndex": 2,
          "explanation": "noopener обнуляет window.opener, а noreferrer дополнительно блокирует отправку заголовка Referer."
        },
        {
          "id": "html6-q3",
          ...
          "options": [
            ...
            "<a href='call:+7 (800) 555-35-35'>Позвонить</a>",
            "<button type='phone'>+78005553535</button>",
            "<a href='tel:+78005553535'>8 (800) 555-35-35</a>"
          ],
          "correctIndex": 3,
          "explanation": "В href требуется чистый международный формат без пробелов и скобок, а текст ссылки можно форматировать для человека."
        },
        {
          "id": "html6-q4",
          ...
          "options": [
            ...
            "scroll-behavior: auto на селекторе body",
            "margin-top: 80px на каждой секции страницы",
            "z-index: 1000 на фиксированной шапке сайта"
          ],
          "correctIndex": 0,
          "explanation": "scroll-padding-top задаёт отступ от верхнего края вьюпорта при прокрутке к якорю, и заголовок не уходит под шапку."
        },
        {
          "id": "html6-q5",
          "question": "Зачем на странице используется скрытая ссылка «Skip to content» (<a href='#main'>)?",
          "options": [
            "Ускоряет загрузку и парсинг JavaScript-бандла",
            "Помогает поисковым ботам индексировать разделы сайта",
            "Позволяет с клавиатуры пропустить шапку и перейти к контенту",
            "Закрывает открытые модальные окна по нажатию Escape"
          ],
          "correctIndex": 2,
          "explanation": "Skip-link — требование WCAG: пользователь с клавиатурой или скринридером не проходит десятки ссылок меню на каждой странице."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            "Браузер резервирует место по пропорциям и сводит CLS к нулю",
            "Файл изображения скачивается по сети заметно быстрее",
            "Без этих атрибутов изображение не отобразится в браузере",
            "Они нужны только для подключения CSS-селекторов к тегу"
          ],
          "correctIndex": 0,
          "explanation": "Явные размеры позволяют браузеру сразу зарезервировать область нужных пропорций, предотвращая сдвиг макета."
        },
        {
          "id": "html7-q2",
          "question": "Какая комбинация атрибутов обязательна для автозапуска фонового <video> на iOS и Android?",
          "options": [
            "autoplay controls preload",
            "autoplay muted loop playsinline",
            "autoplay volume='0' loop",
            "preload='auto' start='0' loop"
          ],
          "correctIndex": 1,
          "explanation": "Мобильные браузеры блокируют автоплей со звуком (нужен muted), а iOS Safari без playsinline разворачивает видео на весь экран."
        },
        {
          "id": "html7-q3",
          "question": "Как правильно разметить чисто декоративное изображение, чтобы не мешать пользователям скринридеров?",
          "options": [
            "Полностью удалить атрибут alt из тега <img>",
            "Написать описание alt='декоративная картинка'",
            "Заменить тег <img> на устаревший тег <object>",
            "Указать пустой alt='' и добавить aria-hidden='true'"
          ],
          "correctIndex": 3,
          "explanation": "Пустой alt='' сообщает скринридеру, что изображение декоративное. Без атрибута alt будет озвучено имя файла."
        },
        {
          "id": "html7-q4",
          "question": "В чём заключается концепция Арт-дирекшн (Art Direction) при использовании тега <picture>?",
          "options": [
            "Автоматическое наложение водяного знака поверх фото",
            "Показ рекламного слоя поверх основного баннера сайта",
            "Смена кадрирования и пропорций под размер экрана",
            "Автоматическая цветокоррекция средствами браузера"
          ],
          "correctIndex": 2,
          "explanation": "<source media='...'> отдаёт разные кадрированные версии изображения, сохраняя главный объект в фокусе на узких экранах."
        },
        {
          "id": "html7-q5",
          "question": "Какой формат растровой графики даёт наилучшее сжатие и поддерживает HDR и прозрачность?",
          "options": [
            "AVIF",
            "GIF",
            "BMP",
          ...
          "correctIndex": 0,
          "explanation": "AVIF на базе кодека AV1 обеспечивает максимальное сжатие, альфа-канал и 10/12-битный HDR-цвет."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            "Меняет цвет и начертание текста заголовков таблицы",
            "Задаёт выравнивание содержимого ячейки по центру",
            "Связывает ячейки данных с заголовком строки или столбца",
            "Без scope таблица не отображается в браузере вовсе"
          ],
          "correctIndex": 2,
          "explanation": "scope задаёт направление заголовка для скринридеров, связывая ячейку <td> со смысловым заголовком <th>."
        },
        {
          "id": "html8-q2",
          "question": "Какой тег списка предназначен для семантической разметки пар «ключ-значение»?",
          "options": [
            "<ul> с вложенными тегами <li>",
            "<dl> с парами <dt> и <dd>",
            "<ol> с атрибутом type='key'",
            "<datalist> с тегами <option>"
          ],
          "correctIndex": 1,
          "explanation": "<dl> (Description List) с <dt> и <dd> — единственный семантический стандарт для пар термин-значение."
        },
        {
          "id": "html8-q3",
          "question": "Что произойдёт при установке атрибута colspan='3' на ячейке <td>?",
          "options": [
            "Ячейка растянется по горизонтали на три столбца",
            "Ячейка разделится на три отдельные строки ниже",
            "Текст внутри ячейки продублируется ровно три раза",
            "Ширина ячейки увеличится ровно на три пикселя"
          ],
          "correctIndex": 0,
          "explanation": "colspan='3' объединяет три колонки в одну, поэтому в этой же строке нужно удалить две лишние ячейки <td>."
        },
        {
          "id": "html8-q4",
          "question": "Какое свойство CSS объединяет двойные рамки соседних ячеек таблицы в единую линию?",
          "options": [
            "border-spacing: 0px;",
            "table-layout: fixed;",
            "border-style: single;",
          ...
          "correctIndex": 3,
          "explanation": "По умолчанию действует border-collapse: separate; значение collapse схлопывает границы ячеек в аккуратную сетку 1px."
        },
        {
          "id": "html8-q5",
          "question": "Где внутри тега <table> должен располагаться заголовочный тег <caption> по спецификации HTML5?",
          "options": [
            "Внутри секции <thead> перед первой строкой <tr>",
            "Первым дочерним элементом сразу после <table>",
            "В самом конце таблицы после секции <tfoot>",
            "В любом месте таблицы — порядок не имеет значения"
          ],
          "correctIndex": 1,
          "explanation": "<caption> обязан быть первым дочерним элементом <table>, чтобы скринридер сразу сообщил название таблицы."
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": [
            "Тег <label> меняет цвет и размер шрифта поля ввода",
            "Клик по метке фокусирует поле, а скринридер его озвучивает",
            "Без тега <label> поле ввода вообще не принимает данные",
            "Метка <label> обязательна только для чекбоксов и радио"
          ],
          "correctIndex": 1,
          "explanation": "Связка label + input критически важна для доступности и увеличивает область нажатия на сенсорных экранах."
        },
        {
          "id": "html9-q2",
          "question": "Какое преимущество даёт использование type='email' и type='tel' на мобильных устройствах?",
          "options": [
            "Шифрует введённые данные перед отправкой формы",
            "Отправляет значение поля через WebSocket-соединение",
            "Подключает специализированную клавиатуру на смартфоне",
            "Меняет цвет курсора и рамки активного поля ввода"
          ],
          "correctIndex": 2,
          "explanation": "iOS и Android адаптируют виртуальную клавиатуру под тип поля, добавляя @, .com или цифровую панель."
        },
        {
          "id": "html9-q3",
          "question": "Что делает атрибут pattern на теге <input>?",
          "options": [
            "Задаёт регулярное выражение для проверки формата ввода",
            "Применяет фоновое изображение к полю ввода данных",
            "Автоматически форматирует номер телефона внутри поля",
            "Добавляет звуковой сигнал при ошибке заполнения формы"
          ],
          "correctIndex": 0,
          "explanation": "pattern принимает регулярное выражение и блокирует отправку формы, если значение не соответствует маске."
        },
        {
          "id": "html9-q4",
          "question": "Чем тег <datalist> отличается от тега <select>?",
          "options": [
            "Тег <datalist> устарел и не поддерживается в Chrome",
            "Между этими элементами нет принципиальной разницы",
            "<datalist> ограничивает выбор строже, чем <select>",
            "<datalist> подсказывает, но разрешает свой вариант"
          ],
          "correctIndex": 3,
          "explanation": "datalist показывает подсказки без ограничения ввода, а select строго ограничивает выбор заданными option."
        },
        {
          "id": "html9-q5",
          "question": "Как объект FormData собирает данные из HTML-формы?",
          "options": [
            "Парсит innerHTML формы и ищет нужные теги вручную",
            "Собирает значения всех полей по атрибуту name, включая файлы",
            "Считывает значение только первого поля внутри формы",
            "Сразу отправляет запрос на сервер в момент создания"
          ],
          "correctIndex": 1,
          "explanation": "new FormData(form) сканирует все поля с атрибутом name и формирует коллекцию пар «имя поля: значение»."
        }
      ]
    }
  },
  {
    ...
    "theory": {
      ...
      "sections": [
        ...
        {
          "title": "Рекомендуемые видеоматериалы: Редкие и полезные теги HTML",
          "content": "Для расширения арсенала семантических инструментов и верстки интерактивных элементов без лишнего JavaScript рекомендуем посмотреть практический обзор:\n\n- **[8 редких HTML тегов, которые почти НИКТО не знает! (YouTube)](https://youtu.be/LcOl02m0sXc?si=DYCzQlqaybPrpFvi)** — наглядный 11-минутный гайд от Владилена Минина по нестандартным и мощным тегам HTML5 (details, dialog, meter, output и др.), которые делают верстку функциональнее и семантичнее."
        }
      ],
      "seniorTips": [
      ...
      "questions": [
        {
          ...
          "options": [
            "Ровно по одному тегу <main> и одному тегу <h1>",
            "Ровно по пять тегов <main> и <h1> на страницу",
            "Минимум три тега <main> и три тега <h1> подряд",
            "Количество тегов <main> и <h1> ничем не ограничено"
          ],
          "correctIndex": 0,
          "explanation": "Спецификация HTML5 и правила SEO требуют один <main> с уникальным контентом и один <h1> с главной темой документа."
        },
        {
          "id": "html10-q2",
          "question": "В чём принципиальное различие между тегами <article> и <section>?",
          "options": [
            "Тег <section> применяется исключительно для видео",
            "Оба тега полностью взаимозаменяемы по смыслу",
            "<article> автономен, а <section> — раздел с заголовком",
            "Тег <article> устарел в актуальной спецификации"
          ],
          "correctIndex": 2,
          "explanation": "<article> самодостаточен и переносим, <section> группирует связанный контент внутри документа и требует заголовка."
        },
        {
          "id": "html10-q3",
          "question": "Зачем в теге <time> указывать атрибут datetime='2026-08-19T14:00:00Z'?",
          "options": [
            "Задаёт цвет и формат отображения даты в тексте",
            "Даёт дату в формате ISO 8601 для роботов и скринридеров",
            "Запускает таймер обратного отсчёта прямо на странице",
            "Переводит указанное время в секунды Unix-эпохи"
          ],
          "correctIndex": 1,
          "explanation": "datetime переводит дату в машиночитаемый формат ISO 8601, понятный поисковым роботам и программам чтения."
        },
        {
          "id": "html10-q4",
          "question": "Что такое Skip Link и какую проблему доступности она решает?",
          "options": [
            "Кнопка быстрого закрытия текущей страницы сайта",
            "Ссылка для пропуска рекламной вставки внутри видео",
            "Скрипт предзагрузки ресурсов следующей страницы",
            "Ссылка перехода с клавиатуры сразу к тегу <main>"
          ],
          "correctIndex": 3,
          "explanation": "Skip Link — стандарт WCAG: по первому нажатию Tab пользователь переходит к основному контенту, минуя шапку и меню."
        },
        {
          "id": "html10-q5",
          "question": "Какой HTML5-тег позволяет создать раскрывающийся аккордеон нативно, без JavaScript?",
          "options": [
            "<details> с вложенным заголовком <summary>",
            "<accordion> с вложенными тегами <item>",
            "<toggle> с вложенным тегом <content>",
            "<dropdown> с вложенным тегом <option>"
          ],
          "correctIndex": 0,
          "explanation": "Связка <details><summary>Заголовок</summary>…</details> поддерживается всеми браузерами нативно."
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      "questions": [
        {
          "id": "html11-q1",
          "question": "Какой формат микроразметки Schema.org официально рекомендован Google?",
          "options": [
            "Microdata через атрибуты itemscope и itemprop",
            "JSON-LD в теге <script type='application/ld+json'>",
            "RDFa через атрибуты vocab, typeof и property",
            "Microformats через специальные CSS-классы тегов"
          ],
          "correctIndex": 1,
          "explanation": "Google рекомендует JSON-LD: он изолирован в теге script, легко генерируется и не ломается при изменении верстки."
        },
        {
          "id": "html11-q2",
          "question": "Почему в мета-теге <meta property='og:image'> обязательно указывать абсолютный URL?",
          "options": [
            "Абсолютный URL позволяет не сжимать изображение",
            "Относительные пути запрещены спецификацией HTML5",
            "Боты соцсетей не знают базовый домен вашей страницы",
            "Абсолютный путь ускоряет анимацию превью ссылки"
          ],
          "correctIndex": 2,
          "explanation": "Краулеры мессенджеров парсят метаданные со своих серверов и требуют полный URL с протоколом https://."
        },
        {
          "id": "html11-q3",
          "question": "Какую проблему решает тег <link rel='canonical' href='...'>?",
          "options": [
            "Ускоряет выполнение JavaScript-кода на странице",
            "Шифрует пароли пользователей при авторизации",
            "Автоматически создаёт файл карты сайта sitemap.xml",
            "Убирает дубли страниц и склеивает ссылочный вес"
          ],
          "correctIndex": 3,
          "explanation": "Canonical указывает эталонный URL документа, защищая сайт от дублей с UTM-метками, сортировками и слешами."
        },
        {
          "id": "html11-q4",
          "question": "Какой тип Schema.org позволяет выводить блок вопросов и ответов прямо в сниппете Google?",
          "options": [
            "QnAPage",
            "AccordionList",
            "FAQPage",
          ...
          "correctIndex": 2,
          "explanation": "FAQPage размечает сущности Question и Answer, и поисковик выводит раскрывающиеся ответы под ссылкой на сайт."
        },
        {
          "id": "html11-q5",
          "question": "Что произойдёт, если в файле robots.txt указать директиву Disallow: /admin/?",
          "options": [
            "Поисковые роботы не будут сканировать раздел /admin/",
            "Каталог /admin/ будет физически удалён с сервера",
            "Доступ к /admin/ закроется для всех пользователей",
            "В разделе /admin/ включится двухфакторная авторизация"
          ],
          "correctIndex": 0,
          "explanation": "Disallow запрещает краулерам обход административного раздела, экономя краулинговый бюджет и скрывая служебные страницы."
        }
      ]
    }
  }
