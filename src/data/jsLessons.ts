  ...
  },
  {
    ...
    "theory": {
      ...
      "sections": [
        ...
        {
          "title": "Рекомендуемые видеоуроки по ООП в JavaScript",
          "content": "Для глубокого закрепления объектно-ориентированного программирования в JavaScript, понимания работы классов под капотом, принципов ООП (инкапсуляция, наследование, полиморфизм) и их применения на практике рекомендуем изучить следующий видеоматериал:\n\n- **[Объектно-Ориентированное Программирование в JavaScript (ООП) с нуля (YouTube)](https://youtu.be/Z7V4ZtiF8Uc?si=U1q-QVCT7sYQ2w69)** — фундаментальный видеоурок с детальным разбором классов, прототипов, наследования через extends и super, инкапсуляции и практических архитектурных паттернов."
        }
      ],
      "seniorTips": [
