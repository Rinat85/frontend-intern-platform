...
export const modulesData: Module[] = [
  ...
  },
  {
    ...
    subtitle: '2 уровня мастерства',
    description: 'Узнайте о работе в ИТ-команде, Agile/Scrum процессах, Git workflow, сборщиках проектов, тестах и карьерном треке инженера.',
    iconName: 'Award',
    accentColor: '#10b981',
