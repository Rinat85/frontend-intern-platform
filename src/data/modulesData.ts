...
export const modulesData: Module[] = [
  ...
  },
  {
    ...
    subtitle: '6 уровней мастерства',
    description: 'Узнайте о работе в ИТ-команде, Agile/Scrum процессах, Git workflow, архитектуре FSD, безопасности, WebSockets/SSE, тестах и Code Review.',
    iconName: 'Award',
    accentColor: '#10b981',
