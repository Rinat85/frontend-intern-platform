      ...
      "questions": [
        {
          ...
          "options": [
            "Формально зафиксировать ответственность автора за возможные баги",
            "Привести форматирование кода к единому стилю внутри команды",
            "Выявить логические и архитектурные ошибки до попадания кода в продакшен",
            "Оценить производительность разработчика для квартальной аттестации"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Что сделано вчера, что планируется сегодня, какие есть блокеры",
            "Сколько задач закрыто, сколько осталось, когда планируется релиз",
            "Какие метрики выросли, какие упали, что решил продакт-менеджер",
            "Что тестирует QA, что ревьюит лид, что деплоит DevOps-инженер"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Обсуждать каждую новую задачу с ментором не дольше 15 минут",
            "Делать перерыв каждые 15 минут работы для сохранения концентрации",
            "Оценивать любую задачу в спринте с точностью до 15 минут работы",
            "Разбираться с проблемой самостоятельно 15–20 минут, затем идти к ментору"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Максимальное количество рабочих часов одного инженера в неделю",
            "Максимальное количество коммитов в одной ветке до её мержа",
            "Максимальное количество задач, одновременно находящихся в одной колонке",
            "Максимальное количество участников, назначаемых на одну задачу"
          ],
          "correctIndex": 2,
  ...
  },
  {
    ...
    "theory": {
      ...
      "sections": [
        ...
        {
          "title": "Рекомендуемые видеоматериалы: Git, GitHub и Git Flow",
          "content": "Для наглядного освоения системы контроля версий Git, базовых команд, веток, разрешения конфликтов, методологии Git Flow и командной работы на GitHub рекомендуем видеоматериалы:\n\n- **[Лучший Гайд по Git Для Начинающих За 15 Минут (YouTube)](https://youtu.be/XuFaQSW79rM?si=_8sCVKAYLWPDe6l4)** — емкий и понятный видеогайд от Vlad Mishustin: базовые команды (init, add, commit, push, pull), работа с ветками (branch, checkout, merge), разрешение конфликтов и работа с GitHub.\n- **[Git и GitHub Курс Для Новичков (YouTube)](https://youtu.be/zZBiln_2FhM?si=SLjs11lPhw0043bJ)** — подробный практический видеокурс от Владилена Минина: архитектура Git, коммиты, ветвление, слияние веток, разрешение конфликтов, работа с удаленным репозиторием GitHub, ssh-ключи и профессиональный workflow.\n- **[Что такое Git flow и когда использовать? (YouTube)](https://youtu.be/umiT0yIsSrc?si=M_zhAKTF7lWv9XDn)** — детальный разбор методологии ветвления Git Flow от Антона Ларичева (PurpleSchool): структура веток (main, develop, feature, release, hotfix), сценарии применения, релизные циклы и сравнение с Trunk-Based Development."
        }
      ],
      "seniorTips": [
    ...
    "quiz": {
      "questions": [
        ...
        },
        {
          ...
          "options": [
            "auth: added login form with validation logic",
            "FEATURE(auth): login form with validation added",
            "feat(auth): add login form with validation",
            "new(auth): login form with validation is added"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "npm ci ставит только dependencies, а npm install ещё и devDependencies",
            "npm ci устанавливает строго по lock-файлу, npm install может обновлять зависимости",
            "npm install работает офлайн из кеша, а npm ci всегда обращается к сети",
            "npm ci собирает проект после установки, а npm install только скачивает пакеты"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "devDependencies — react нужен только на этапе сборки бандла",
            "peerDependencies — версию react выбирает потребитель пакета",
            "optionalDependencies — приложение способно работать и без react",
            "dependencies — react необходим приложению в runtime"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Пайплайн остановится, а Pull Request будет заблокирован для мержа",
            "Остальные шаги выполнятся, а результат пометится предупреждением",
            "Пайплайн автоматически перезапустится до трёх раз подряд",
            "Ошибка попадёт в лог, но мерж в main останется доступным"
          ],
          "correctIndex": 0,
      ...
      "questions": [
        {
          ...
          "options": [
            "Компонент должен использовать не более одного React-хука",
            "Компонент должен рендерить строго один корневой HTML-элемент",
            "Компонент должен переиспользоваться минимум в двух других модулях",
            "Компонент отвечает за одну задачу: верстку без запросов, валидации и стейта"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Проверка краевых случаев в начале функции с немедленным return",
            "Обёртывание всей логики функции в единый блок try/catch",
            "Вынесение всех условий функции в отдельный объект-конфигурацию",
            "Проверка прав доступа пользователя перед рендером компонента"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Критическое замечание, блокирующее мерж Pull Request",
            "Замечание, требующее обязательного письменного ответа автора",
            "Мелкое стилевое пожелание, не блокирующее мерж Pull Request",
            "Замечание, автоматически сгенерированное линтером в пайплайне"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Проектируйте абстракции заранее, чтобы упростить будущие фичи",
            "Не реализуйте функциональность, пока в ней нет текущей потребности",
            "Не подключайте сторонние библиотеки, если можно написать самому",
            "Не оптимизируйте код, пока профайлер не показал узкое место"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Один PR на весь спринт, чтобы ревью проходило единым блоком",
            "От 800 до 1500 строк — компромисс между полнотой и временем ревью",
            "Размер не имеет значения, важна только подробность описания",
            "Компактный PR на 150–400 строк по одной конкретной задаче"
          ],
          "correctIndex": 3,
      ...
      "questions": [
        {
          ...
          "options": [
            "Vite отдаёт нативные ES-модули по требованию, а зависимости готовит esbuild на Go",
            "Vite собирает весь проект в бандл, но кеширует его между запусками",
            "Vite переносит транспиляцию кода в отдельный поток Web Worker браузера",
            "Vite отключает проверку типов и линтинг на этапе запуска dev-сервера"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Использование модулей CommonJS и динамического require()",
            "Отключение генерации source maps в production-сборке",
            "Использование статического синтаксиса ES-модулей import/export",
            "Включение минификации через опцию build.minify: 'terser'"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "pnpm устанавливает пакеты без обращения к внешнему npm-реестру",
            "pnpm хранит пакеты в глобальном store и связывает их жёсткими ссылками",
            "pnpm автоматически обновляет все зависимости до последних версий",
            "pnpm собирает проект без участия сборщиков Vite или Webpack"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Разрешены любые обновления, включая мажорную версию 3.0.0",
            "Разрешены только patch-обновления в пределах версии 2.4.x",
            "Версия зафиксирована жёстко: будет установлена ровно 2.4.1",
            "Разрешены minor и patch обновления: от 2.4.1 до версий ниже 3.0.0"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Он ускоряет установку, кешируя архивы пакетов внутри репозитория",
            "Он фиксирует точные версии всех подзависимостей и их контрольные суммы",
            "Он описывает, какие зависимости попадут в production-бандл",
            "Он хранит список скриптов, доступных через команду npm run"
          ],
          "correctIndex": 1,
    ...
    "quiz": {
      "questions": [
        ...
        },
        {
          ...
          "options": [
            "Измеряет задержку между действием пользователя и отрисовкой следующего кадра",
            "Измеряет время до полной загрузки всех скриптов и стилей страницы",
            "Измеряет долю сессий, в которых пользователь не совершил ни одного клика",
            "Измеряет задержку между DNS-запросом и первым байтом ответа сервера"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Атрибут loading='lazy' полностью отключает кеширование изображения",
            "Браузер загружает такое изображение в пониженном качестве и разрешении",
            "Изображение загружается только после первого клика пользователя",
            "Браузер откладывает запрос изображения, ухудшая LCP на 1–2 секунды"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Загружать все изображения синхронно, блокируя парсинг документа",
            "Задавать width/height или aspect-ratio и использовать скелетонные экраны",
            "Переводить все блоки страницы в position: absolute относительно body",
            "Отключать веб-шрифты и использовать только системные семейства"
          ],
          "correctIndex": 1,
      ...
      "questions": [
        {
          ...
          "options": [
            "HTTP/2 передаёт заголовки в текстовом виде без сжатия HPACK",
            "HTTP/2 мультиплексирует множество запросов в одном TCP-соединении",
            "HTTP/2 требует отдельного TCP-соединения на каждый ресурс страницы",
            "HTTP/2 запрещает кеширование ответов на стороне браузера"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Запрошенный ресурс удалён с сервера и больше не доступен",
            "Сервер перенаправил запрос на другой постоянный адрес ресурса",
            "Клиент должен повторить запрос с корректным заголовком авторизации",
            "Контент не изменился, и браузер должен взять его из локального кеша"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Повторный вызов метода приводит к тому же состоянию, что и один вызов",
            "Метод передаёт тело запроса в сжатом виде, экономя сетевой трафик",
            "Метод обрабатывается сервером быстрее за счёт кеширования ответа",
            "Метод может использоваться только внутри одного домена (same-origin)"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Cache-Control: public, max-age=31536000, immutable",
            "Cache-Control: no-store, чтобы страница не сохранялась в кеше",
            "Cache-Control: no-cache, чтобы браузер проверял свежесть перед показом",
            "Cache-Control: private, max-age=86400 для суточного кеша"
          ],
          "correctIndex": 2,
      ...
      "questions": [
        {
          ...
          "options": [
            "PubSub гарантирует строгий порядок и синхронность обработки событий",
            "PubSub позволяет обойтись без сборки проекта и системы модулей",
            "PubSub заменяет глобальное хранилище состояния и сетевой слой",
            "Издатель и подписчики не знают друг о друге, что даёт слабую связанность"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Proxy с ловушками get и set для отслеживания зависимостей",
            "Object.freeze для защиты состояния от случайных мутаций",
            "requestAnimationFrame для пакетной отрисовки изменений",
            "MutationObserver для отслеживания изменений в дереве DOM"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Объединение нескольких компонентов в один файл при сборке бандла",
            "Наследование одного компонента от другого через классы ES6",
            "Набор связанных компонентов, делящих общий контекст (<Select.Option>)",
            "Передача компонента в другой компонент через пропс render"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Чтобы повторно вызвать обработчик с обновлёнными аргументами",
            "Чтобы очистить обработчик при размонтировании и избежать утечек памяти",
            "Чтобы гарантировать порядок вызова подписчиков в очереди событий",
            "Чтобы передать событие дальше в родительский брокер событий"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Когда нужно взаимозаменяемо переключать алгоритмы во время работы",
            "Когда нужно гарантировать единственный экземпляр класса в приложении",
            "Когда нужно уведомлять множество объектов об изменении состояния",
            "Когда нужно перехватывать доступ к свойствам целевого объекта"
          ],
          "correctIndex": 0,
      ...
      "questions": [
        {
          ...
          "options": [
            "Делает поля 'password' и 'salt' опциональными в типе User",
            "Оставляет в новом типе только поля 'password' и 'salt'",
            "Создаёт новый тип на основе User без полей 'password' и 'salt'",
            "Проверяет в рантайме, что поля 'password' и 'salt' отсутствуют"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Типы TypeScript исчезают при компиляции, а Zod валидирует данные в рантайме",
            "Zod ускоряет компиляцию TypeScript, кешируя результаты проверки типов",
            "Zod генерирует интерфейсы бэкенда по OpenAPI-спецификации автоматически",
            "Zod заменяет утилитные типы Omit, Pick и Partial более коротким синтаксисом"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Объединение нескольких интерфейсов через оператор пересечения &",
            "Приведение типа объединения к конкретному типу через оператор as",
            "Ограничение дженерика списком допустимых литеральных значений",
            "Объединение типов с общим литеральным полем, по которому TS сужает тип"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Оставляет в типе только обязательные поля, убирая опциональные",
            "Делает все свойства типа опциональными — удобно для Patch/Update",
            "Запрещает мутацию свойств, помечая их как readonly",
            "Извлекает тип значения по указанному ключу объекта"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "unknown быстрее компилируется и уменьшает размер итогового бандла",
            "unknown допускает любые операции, а any требует явного приведения",
            "any отключает проверки, а unknown требует сузить тип перед использованием",
            "unknown автоматически валидирует значение по структуре объекта"
          ],
          "correctIndex": 2,
      ...
      "questions": [
        {
          ...
          "options": [
            "CI автоматически проверяет код при push/PR, CD доставляет его на среды",
            "CI выполняет сборку локально, а CD собирает проект на удалённом сервере",
            "CI отвечает за код-ревью командой, а CD — за автоматические тесты",
            "CI работает только с ветвью main, а CD — только с feature-ветками"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "npm ci кеширует пакеты между запусками, ускоряя повторные сборки",
            "npm ci пропускает devDependencies, уменьшая время установки",
            "npm ci проверяет пакеты на уязвимости перед их установкой",
            "npm ci ставит зависимости строго по lock-файлу, обеспечивая воспроизводимость"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Локальный сервер предпросмотра production-сборки перед коммитом",
            "Уникальный URL со сборкой каждого PR для визуальной проверки до мержа",
            "Скриншоты интерфейса, автоматически прикрепляемые к Pull Request",
            "Копия продакшена, доступная только внутри корпоративной сети"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Новая версия раскатывается сразу на всех пользователей одновременно",
            "Трафик мгновенно переключается между двумя идентичными окружениями",
            "Новая версия сначала получает 1–5% трафика с последующим расширением",
            "Новая версия доступна только внутренним сотрудникам и тестировщикам"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Чтобы в стек-трейсах видеть файлы и строки исходного, а не минифицированного кода",
            "Чтобы уменьшить размер production-бандла за счёт выноса отладочных данных",
            "Чтобы Sentry мог сам пересобрать приложение и воспроизвести ошибку",
            "Чтобы автоматически связывать ошибки с задачами в трекере Jira"
          ],
          "correctIndex": 0,
      ...
      "questions": [
        {
          ...
          "options": [
            "XSS работает только с cookie, а CSRF — только с localStorage",
            "CSRF внедряет скрипт на страницу, а XSS подменяет DNS-записи домена",
            "XSS исполняет вредоносный скрипт на вашем сайте, CSRF использует чужую сессию",
            "XSS возможен только по HTTP, а CSRF — только по HTTPS-соединению"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Любой скрипт на странице, включая внедрённый через XSS, может прочитать токен",
            "localStorage не поддерживает хранение строк длиннее 1024 символов",
            "localStorage полностью очищается при закрытии вкладки браузера",
            "localStorage доступен только скриптам, загруженным по протоколу HTTP"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Шифрует содержимое cookie симметричным ключом сервера",
            "Разрешает отправку cookie только по защищённому протоколу HTTPS",
            "Блокирует отправку cookie при переходах со сторонних сайтов",
            "Запрещает чтение cookie из JavaScript, защищая сессию при XSS"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Автоматически экранирует пользовательский ввод перед вставкой в DOM",
            "Задаёт белый список источников скриптов и блокирует инлайн-код",
            "Принудительно переводит все запросы страницы на протокол HTTPS",
            "Запрещает встраивание страницы во фреймы на сторонних доменах"
          ],
          "correctIndex": 1,
      ...
      "questions": [
        {
          ...
          "options": [
            "Short Polling с интервалом опроса в 100 миллисекунд",
            "WebSockets с полнодуплексным каналом и Heartbeat",
            "Server-Sent Events (EventSource) — push-поток поверх HTTP с реконнектом",
            "WebRTC Data Channel с прямым peer-to-peer соединением"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Для измерения средней задержки сети и построения графиков latency",
            "Для повторной авторизации клиента каждые 30 секунд соединения",
            "Для сжатия передаваемых по сокету сообщений на стороне клиента",
            "Для выявления «зомби-соединений» и удержания сокета от закрытия прокси"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Клиент повторяет подключение с фиксированным интервалом в одну секунду",
            "Задержка между попытками растёт экспоненциально: 1с → 2с → 4с → 8с",
            "Клиент перезагружает страницу после трёх неудачных попыток подряд",
            "Сервер сам инициирует переподключение, отправляя клиенту push-запрос"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Сообщение автоматически буферизуется браузером и уйдёт после открытия",
            "Сообщение молча отбрасывается без каких-либо ошибок в консоли",
            "Будет выброшено исключение InvalidStateError — нужна собственная очередь",
            "Сокет принудительно перейдёт в состояние OPEN и отправит данные"
          ],
          "correctIndex": 2,
      ...
      "questions": [
        {
          ...
          "options": [
            ...
            "Строго снизу вверх: shared → entities → features → widgets → pages",
            "Только горизонтально: между слайсами внутри одного и того же слоя",
            "В любом направлении при условии импорта через Public API слайса"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Да, если импортируется только TypeScript-тип, а не значение",
            "Да, при условии импорта строго через Public API слайса",
            "Да, если импорт выполняется динамически через import()",
            "Нет: entities лежат ниже features и не могут от них зависеть"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Является точкой входа приложения, монтирующей корневой компонент",
            "Является Public API слайса и запрещает глубокие внутренние импорты",
            "Содержит конфигурацию линтера, проверяющего границы слоёв",
            "Реэкспортирует все файлы слайса, включая внутренние утилиты"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Бизнес-модели пользователей, заказов и товаров вместе с их стейтом",
            "Маршрутизируемые экраны приложения и глобальные провайдеры",
            "Переиспользуемый код без бизнес-логики: UI-kit, API-клиент, утилиты",
            "Пользовательские сценарии: авторизация, фильтрация, добавление в корзину"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "eslint-plugin-boundaries — правила границ слоёв в IDE и CI",
            "Prettier — автоформатирование импортов по алфавиту и группам",
            "Webpack Bundle Analyzer — визуализация связей между чанками",
            "TypeScript Path Aliases — сокращение путей импорта через @/"
          ],
          "correctIndex": 0,
      ...
      "questions": [
        {
          ...
          "options": [
            "Синхронное, асинхронное, отложенное и вычисляемое состояние",
            "Local (компонентное), Global (клиентское), Server (кеш API), URL (маршрутное)",
            "Мутабельное, иммутабельное, персистентное и временное состояние",
            "Props, State, Context и Refs как четыре источника данных компонента"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Redux не умеет хранить массивы и вложенные объекты без нормализации",
            "Redux работает только синхронно и не поддерживает асинхронные экшены",
            "Redux держит состояние в памяти и теряет его при перезагрузке страницы",
            "Серверные данные устаревают: нужны кеш, ревалидация и повторы запросов"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Компактнее Redux, не требует Provider и почти не имеет бойлерплейта",
            "Автоматически кеширует ответы API и ревалидирует их в фоне",
            "Гарантирует иммутабельность состояния на уровне рантайма",
            "Синхронизирует состояние с URL-параметрами из коробки"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Максимальное время ожидания ответа сервера до отмены запроса",
            "Время, после которого данные полностью удаляются из кеша",
            "Время, в течение которого кеш считается свежим и запрос не повторяется",
            "Интервал, с которым выполняется фоновый повторный запрос данных"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "В локальном useState компонента страницы каталога",
            "В URL через useSearchParams — ссылкой можно поделиться, работает history",
            "В localStorage, чтобы фильтры сохранялись между визитами",
            "В глобальном сторе Zustand с подключённым middleware persist"
          ],
          "correctIndex": 1,
      ...
      "questions": [
        {
          ...
          "options": [
            "90% E2E, 5% Integration и 5% Unit для максимальной уверенности",
            "Равные доли: по одной трети Unit, Integration и E2E тестов",
            "50% Integration, 40% E2E и 10% Unit для проверки сценариев",
            "60–70% Unit, 20–30% Integration и около 10% E2E тестов"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "getByRole('button', { name: /сохранить/i }) — поиск по роли доступности",
            "getByTestId('save-button') — поиск по служебному data-атрибуту",
            "container.querySelector('.btn-save') — поиск по CSS-классу элемента",
            "getByTitle('Сохранить') — поиск по значению атрибута title"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "MSW подменяет реализацию fetch, не затрагивая сетевой уровень",
            "MSW поднимает реальный бэкенд в контейнере на время прогона тестов",
            "MSW перехватывает запросы на сетевом уровне, оставляя код клиента нетронутым",
            "MSW генерирует моки автоматически из OpenAPI-спецификации проекта"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Требования → реализация → ручное тестирование перед релизом",
            "Red: падающий тест → Green: минимальный код → Refactor: чистка кода",
            "Lint → Test → Build как последовательность шагов CI-пайплайна",
            "Разработка кода, затем написание тестов и замер покрытия"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Не требует написания кода: тесты записываются только мышью",
            "Работает без браузера, эмулируя DOM прямо в среде Node.js",
            "Заменяет модульные тесты, покрывая всю пирамиду тестирования",
            "Авто-ожидание элементов и поддержка Chromium, WebKit и Firefox"
          ],
          "correctIndex": 3,
      ...
      "questions": [
        {
          ...
          "options": [
            "Исполняются на сервере и не попадают в клиентский бандл, имея доступ к БД",
            "Работают в браузере быстрее за счёт компиляции в WebAssembly",
            "Автоматически кешируют результат рендера в Service Worker клиента",
            "Позволяют свободно использовать useState и обработчики onClick"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Сервер повторно рендерит страницу при каждом действии пользователя",
            "Браузер сжимает и кеширует полученный HTML в локальном хранилище",
            "Браузер скачивает JS-бандл, сопоставляет его с HTML и навешивает обработчики",
            "Фреймворк переносит стили из JS-объектов в статические CSS-файлы"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Каждый интерактивный блок изолируется в отдельном iframe со своим контекстом",
            "Страница отдаётся как статический HTML, а гидрируются лишь отдельные виджеты",
            "Приложение делится на независимо деплоящиеся микрофронтенды с общим React",
            "Компоненты рендерятся на edge-серверах, ближайших к пользователю"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Полная пересборка всего сайта запускается при каждом запросе страницы",
            "HTML собирается на сервере заново на каждый входящий запрос клиента",
            "Страница рендерится в браузере, а сервер отдаёт только пустой каркас",
            "Статика отдаётся из CDN, а по истечении revalidate тихо регенерируется"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Сервер сразу отдаёт каркас страницы, досылая медленные блоки потоком",
            "Клиент повторяет загрузку данных, если первый запрос завершился ошибкой",
            "Тяжёлые компоненты выносятся в отдельные чанки и грузятся по клику",
            "Сервер откладывает ответ до готовности всех данных, отдавая цельный HTML"
          ],
          "correctIndex": 0,
      ...
      "questions": [
        {
          ...
          "options": [
            "Уменьшает размер клиентского бандла за счёт удаления мёртвого кода",
            "Позволяет писать фронтенд и бэкенд на одном языке в одном репозитории",
            "Даёт командам возможность разрабатывать и деплоить свои части независимо",
            "Обеспечивает единый дизайн-код и стилистическую консистентность интерфейса"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Чтобы уменьшить размер remoteEntry.js, исключив React из его чанков",
            "Чтобы в памяти был один экземпляр React и хуки с контекстами не ломались",
            "Чтобы Host мог принудительно обновить версию React во всех Remote-модулях",
            "Чтобы React загружался раньше остальных разделяемых зависимостей"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Точку входа Host-приложения, монтирующую корневой React-компонент",
            "Конфигурационный файл сборки с описанием exposes и remotes",
            "Собранный бандл микрофронтенда со всем его кодом и зависимостями",
            "Манифест удалённого модуля со списком exposes и shared-зависимостей"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Через типизированные CustomEvent / Event Bus либо параметры URL",
            "Через прямой вызов методов, выставленных в глобальный объект window",
            "Через общий мутируемый объект без типизации в localStorage",
            "Через прямой импорт внутренних модулей соседнего микрофронтенда"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Повторно монтирует упавший модуль, пока он не отрендерится успешно",
            "Перехватывает сетевые ошибки запросов внутри удалённого модуля",
            "Изолирует сбой: падает только этот блок, остальное приложение работает",
            "Проверяет совместимость версий shared-зависимостей перед монтированием"
          ],
          "correctIndex": 2,
      ...
      "questions": [
        {
          ...
          "options": [
            "В главном потоке рендеринга рядом с обработчиками событий DOM",
            "В отдельном фоновом потоке без прямого доступа к DOM и window",
            "В процессе Node.js на сервере, обслуживающем данный домен",
            "В изолированном iframe, создаваемом браузером при регистрации"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Для персональных данных: баланса счёта и списка заказов пользователя",
            "Для мутирующих POST- и PUT-запросов к API приложения",
            "Для сообщений чата, приходящих по сокету в реальном времени",
            "Для неизменяемых ассетов: шрифтов, логотипов, хешированных бандлов"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Тело ответа — поток, читаемый лишь однажды, поэтому нужна копия",
            "Метод clone() сжимает тело ответа перед записью в Cache Storage",
            "Без clone() ответ сохранится без HTTP-заголовков и статус-кода",
            "clone() требуется, чтобы запись в кеш выполнилась асинхронно"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Синхронизирует системное время устройства с сервером приложения",
            "Обновляет закешированные ассеты по расписанию раз в сутки",
            "Откладывает запросы при отсутствии сети и выполняет их при её появлении",
            "Синхронизирует состояние между несколькими открытыми вкладками"
          ],
          "correctIndex": 2,
      ...
      "questions": [
        {
          ...
          "options": [
            "Тесты, деплой и мониторинг как три этапа доставки кода",
            "Логи, дашборды и алерты как три уровня оповещения команды",
            "Скорость, стабильность и безопасность как три цели наблюдаемости",
            "Логи (события), Метрики (числовые показатели) и Трейсы (путь запроса)"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Файлы .map слишком велики и заметно замедляют загрузку страницы",
            "Они содержат маппинг к исходному коду и раскрывают его публично",
            "CDN не поддерживает MIME-тип файлов с расширением .map",
            "Браузер начнёт исполнять код из .map вместо минифицированного бандла"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Список всех подключённых npm-пакетов на момент возникновения ошибки",
            "Дерево вызовов функций от точки входа приложения до места сбоя",
            "Хронологию действий пользователя перед ошибкой: клики, переходы, запросы",
            "Историю релизов, в которых эта ошибка ранее уже воспроизводилась"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "0.1–0.2 — достаточно для аналитики и не исчерпывает квоту",
            "1.0 — только полная выборка даёт достоверную статистику",
            "0.0 — трейсинг стоит включать лишь при разборе инцидента",
            "0.9 — почти полная выборка при небольшой экономии квоты"
          ],
          "correctIndex": 0,
      ...
      "questions": [
        {
          ...
          "options": [
            "Полностью исключает необходимость кеширования ответов на клиенте",
            "Устраняет Over-fetching и Under-fetching: нужные данные за один запрос",
            "Переводит передачу данных на бинарный формат вместо текстового JSON",
            "Гарантирует сквозную типизацию без генерации типов и схем"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Разбивает ответы на плоские сущности по ключу __typename:id",
            "Кеширует каждый ответ целиком по URL и телу запроса",
            "Сохраняет отрендеренную разметку компонентов между переходами",
            "Хранит данные в IndexedDB и переживает перезагрузку страницы"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Отправляет мутацию повторно, пока сервер не подтвердит успешный результат",
            "Заранее загружает данные соседних экранов на основе поведения пользователя",
            "Мгновенно обновляет интерфейс до ответа сервера с откатом при ошибке",
            "Показывает скелетон вместо контента на время выполнения мутации"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "tRPC работает без сервера, выполняя процедуры прямо в браузере клиента",
            "tRPC сериализует данные в бинарный Protobuf поверх протокола HTTP/2",
            "tRPC позволяет клиенту самому выбирать нужные поля в ответе сервера",
            "tRPC даёт сквозную типизацию без SDL-схем и шага кодогенерации"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Он передаёт данные без шифрования, экономя время на TLS-рукопожатии",
            "Protobuf сериализует данные в компактный бинарный формат, быстрый в парсинге",
            "Он открывает по одному TCP-соединению на каждый вызов процедуры",
            "Он выполняет часть бизнес-логики на клиенте, разгружая сервер"
          ],
          "correctIndex": 1,
      ...
      "questions": [
        {
          ...
          "options": [
            "Deployment — стратегия выката и откатов релизов в продакшене",
            "Debugging — инструменты диагностики и профилирования клиента",
            "Data Model & Client State — сущности, связи и клиентский кеш",
            "Design System — токены, компоненты и правила визуального языка"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Описать решение, компромиссы и альтернативы и собрать фидбек до кода",
            "Зафиксировать итоговую архитектуру после завершения разработки",
            "Сформировать список задач для декомпозиции эпика в спринте",
            "Сгенерировать документацию по API из аннотаций в исходном коде"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Ускоряет загрузку изображений, отдавая их через ближайший edge-узел",
            "Кеширует уже загруженные страницы ленты, экономя сетевой трафик",
            "Переносит вычисление разметки списка в фоновый Web Worker",
            "Держит в DOM только видимые карточки, спасая память и отзывчивость"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Курсор позволяет мгновенно перейти на произвольную страницу по номеру",
            "Она исключает дубликаты и пропуски при вставке нового контента",
            "Она уменьшает объём ответа сервера за счёт сжатия полезной нагрузки",
            "Она позволяет запрашивать записи параллельно несколькими потоками"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Постепенное снижение частоты запросов к перегруженному сервису",
            "Плавное уменьшение качества анимаций на слабых устройствах",
            "Сохранение базовой работоспособности UI при отказе части сервисов",
            "Поэтапный отказ от поддержки устаревших версий браузеров"
          ],
          "correctIndex": 2,
      ...
      "questions": [
        {
          ...
          "options": [
            ...
            "Velocity, Story Points, Burndown Rate и Sprint Predictability",
            "Code Coverage, Cyclomatic Complexity, Tech Debt Ratio и Bug Count",
            "LCP, INP, CLS и Apdex Score как показатели качества продукта"
          ],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "options": [
            "Заморозка новых фич на время полного переписывания системы с нуля",
            "Изоляция легаси-кода в отдельном iframe внутри нового приложения",
            "Поэтапная замена модулей монолита новым стеком через роутер-прокси",
            "Автоматическая миграция кода на новый фреймворк с помощью кодмодов"
          ],
          "correctIndex": 2,
        ...
        },
        {
          ...
          "options": [
            "Зафиксировать, кто допустил ошибку, для оценки в перформанс-ревью",
            "Найти системную причину сбоя и внедрить защиту от его повторения",
            "Быстро откатить релиз и восстановить работу сервиса для пользователей",
            "Оценить ущерб от простоя и рассчитать компенсации по условиям SLA"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Не более 20% задач спринта могут переноситься в следующий спринт",
            "Каждый инженер тратит 20% рабочего времени на собственные пет-проекты",
            "Не более 20% кодовой базы может оставаться без покрытия тестами",
            "20% ёмкости каждого спринта резервируется на техдолг и рефакторинг"
          ],
          "correctIndex": 3,
        ...
        },
        {
          ...
          "options": [
            "Новый инженер деплоит первый рабочий коммит в прод в первый же день",
            "Деплой в продакшен выполняется только в первый рабочий день недели",
            "Первый релиз новой фичи всегда идёт через canary на 1% трафика",
            "Новичок получает доступ к продакшену только после испытательного срока"
          ],
          "correctIndex": 0,
  ...
  "quiz": {
    "questions": [
      ...
      },
      {
        ...
        "options": [
          "fix(catalog): speed up catalog list rendering",
          "refactor(catalog): speed up catalog list rendering",
          "chore(catalog): speed up catalog list rendering",
          "perf(catalog): speed up catalog list rendering"
        ],
        "correctIndex": 3,
      ...
      },
      {
        ...
        "options": [
          "Указанием типа major(api) вместо feat или refactor в заголовке",
          "Символом '!' после типа/скоупа либо блоком BREAKING CHANGE в футере",
          "Написанием слова BREAKING заглавными буквами в начале заголовка",
      ...
      },
      {
        ...
        "options": [
          "Заголовок до 50 символов, строки тела переносятся на 72 символах",
          "Не более 50 коммитов в ветке и не более 72 строк в одном файле",
          "Не менее 50 тестов в проекте и не менее 72% покрытия кода",
          "Тело коммита до 50 строк, а заголовок не длиннее 72 символов"
        ],
        "correctIndex": 0,
  ...
  "quiz": {
    "questions": [
      ...
      },
      {
        ...
        "options": [
          "Virtual DOM с алгоритмом Reconciliation и архитектурой Fiber",
          "Proxy-реактивность с автоматическим отслеживанием зависимостей",
          "Компиляцию шаблонов в императивные DOM-операции при сборке",
          "Сигналы (Signals) с точечным обновлением конкретных DOM-узлов"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Метод push() не поддерживается для состояния, созданного через useState",
          "Virtual DOM отслеживает только примитивы, но не массивы и объекты",
          "React сравнивает ссылки, а мутация не создаёт новую ссылку на массив",
          "Мутация допустима, но требует ручного вызова метода forceUpdate()"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Данные идут вниз через Props, а обратная связь — через callback / emit",
          "Данные передаются только от сервера к клиенту без обратных запросов",
          "Дочерний компонент может напрямую изменять Props родительского компонента",
          "Состояние хранится только в глобальном сторе и не передаётся через Props"
        ],
        "correctIndex": 0,
